...
##Input run numbers##                                                                                                                                                                                             
inputFile="/home/${USER}/work/JLab/hallc_replay_lt/UTIL_PION/batch/inputRuns" # Path to your input file which is just a list of run numbers, see templates
...
while true; do
    ...
    case $yn in
		...
		echo "date" >> ${batch} 
		echo "cd /home/${USER}/work/JLab/hallc_replay_lt/UTIL_PION/scripts_batch" >> ${batch} # Tell your job to go to the directory with the script you want to run
