...
// The class definition in HeepCoinYield.h has been generated automatically
...
//
// root> T->Process("HeepCoinYield.C")
// root> T->Process("HeepCoinYield.C","some options")
// root> T->Process("HeepCoinYield.C+")
//
...
void HeepCoinYield::SlaveBegin(TTree * /*tree*/)
{
  ...
  h2WvsQ2                 = new TH2F("WvsQ2","Q^{2} vs W;Q^{2};W",400,1,3,100,0.5,1.5);
