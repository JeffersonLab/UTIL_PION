#ifndef HeepCoinYield_h
#define HeepCoinYield_h
...
class HeepCoinYield : public TSelector {
 public :
  ...
  ClassDef(HeepCoinYield,0);

};

#endif

#ifdef HeepCoinYield_cxx
void HeepCoinYield::Init(TTree *tree)
{
