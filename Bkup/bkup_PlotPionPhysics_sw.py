...
# This version of script is for shift workers
...
# Block for grabing Prompt/Random selection values from PARAM file
...
#P_ngcer_npeSum_pions_cut_all = ROOT.TH1D("P_ngcer_npeSum_pions_cut_all", "SHMS NGC npeSum; SHMS_ngcer_npeSum; Counts", 200, -10, 50)
...
# Q2 vs W, epsilon, MM (with BG sub AND number of pion events on the plot) and t vs phi (polar)

# Saving histoggrams in PDF
