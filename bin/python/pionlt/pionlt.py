...
''
This method calls several methods in pionlt package. It is required to create properly formated
dictionaries. The evaluation must be in the analysis script because the analysis variables (i.e. the
leaves of interest) are not defined in the pionlt package. This makes the system more flexible
...
class pyDict(dict):
    '''
    When calling pionlt package, you may define a dictionary in the script. This dictionary will contain
...
class pyEquation():
    '''            
    This class stores a variety of equations often used in the PionLT analysis procedure
    '''
...
class pyPlot(pyDict):
    '''
    This is the most extensive class of the pionlt package. This class will perform many required tasks
    ...
    def polarPlot(self,theta,r,title,thetalabel,rlabel,bintheta,binr,pyMisc,
        ...
        '''
        Creates polar plots (useful for pionlt analysis). Old script, has not been checked in a while.
        '''
