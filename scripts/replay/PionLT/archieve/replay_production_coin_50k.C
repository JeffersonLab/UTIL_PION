void replay_production_coin_50k (Int_t RunNumber = 0, Int_t MaxEvent = 0) {
  ...
  const char* ROOTFileNamePattern = "UTIL_PION/ROOTfiles/Analysis/50k/Pion_coin_replay_production_%d_%d.root";
