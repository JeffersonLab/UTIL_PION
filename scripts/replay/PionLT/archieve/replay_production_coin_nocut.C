void replay_production_coin_nocut (Int_t RunNumber = 0, Int_t MaxEvent = 0) {
  ...
  const char* ROOTFileNamePattern = "UTIL_PION/ROOTfiles/Analysis/PionLT/Pion_coin_replay_production_nocut_%d_%d.root";
  ...
  // Define cuts file
  analyzer->SetCutFile("UTIL_PION/config/DEF-files/Online_Coin_Production_Cuts_Loose.def");  // optional
