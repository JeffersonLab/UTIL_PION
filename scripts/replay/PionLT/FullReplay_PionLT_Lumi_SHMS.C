void FullReplay_PionLT_Lumi_SHMS (Int_t RunNumber = 0, Int_t MaxEvent = 0) {
...
//  pathList.push_back("./cache_pionlt");
  ...
  const char* ROOTFileNamePattern = "/volatile/hallc/c-pionlt/junaid/ROOTfiles/Analysis/Lumi/PionLT_SHMS_Lumi_replay_production_%d_%d.root";
  //const char* ROOTFileNamePattern = "/cache/hallc/c-pionlt/analysis/PionLT_Fullreplay_Analysis_Files_Pass1_2021/Analysis/Lumi/PionLT_SHMS_Lumi_replay_production_%d_%d.root";
  //const char* ROOTFileNamePattern = "/cache/hallc/c-pionlt/analysis/PionLT_Fullreplay_Analysis_Files_Pass1_2022/Analysis/Lumi/PionLT_SHMS_Lumi_replay_production_%d_%d.root";
  ...
  if (RunNumber >= 11700 && RunNumber <= 13042){
   analyzer->SetCutFile("DEF-files/PRODUCTION/PionLT_DEF/Aero_1p011/Offline_Lumi_Sing_SHMS_Cuts.def");
  }
  else if (RunNumber >= 13043 && RunNumber <= 13130){
   analyzer->SetCutFile("DEF-files/PRODUCTION/PionLT_DEF/Aero_1p030/Offline_Lumi_Sing_SHMS_Cuts.def");
  }
  ...
  analyzer->SetSummaryFile(Form("/volatile/hallc/c-pionlt/junaid/REPORT_OUTPUT/SUMMARY_OUTPUT/Lumi/PionLT_SHMS_Lumi_summary_production_%d_%d.report", RunNumber, MaxEvent));  // optional
  ...
  Form("/volatile/hallc/c-pionlt/junaid/REPORT_OUTPUT/Analysis/Lumi/PionLT_replay_SHMS_Lumi_%d_%d.report", RunNumber, MaxEvent));  // optional
...
/*
  ...
  // File to record accounting information for cuts
  analyzer->SetSummaryFile(Form("/cache/hallc/c-pionlt/analysis/PionLT_Fullreplay_Analysis_Files_Pass1_2021/SUMMARY_OUTPUT/Lumi/PionLT_SHMS_Lumi_summary_production_%d_%d.report", RunNumber, MaxEvent));  // optional
  // Start the actual analysis.
  analyzer->Process(run);
  // Create report file from template
  //  analyzer->PrintReport("TEMPLATES/COIN/PRODUCTION/COIN_PROD.template",
  analyzer->PrintReport("TEMPLATES/COIN/PRODUCTION/PionLT_TEMP/PionLT_Offline_Luminosity.template",
  Form("/cache/hallc/c-pionlt/analysis/PionLT_Fullreplay_Analysis_Files_Pass1_2021/REPORT_OUTPUT/Lumi/PionLT_replay_SHMS_Lumi_%d_%d.report", RunNumber, MaxEvent));  // optional
  // Helicity scalers output
  analyzer->PrintReport("TEMPLATES/HMS/SCALERS/hhelscalers.template",
  			Form("/cache/hallc/c-pionlt/analysis/PionLT_Fullreplay_Analysis_Files_Pass1_2021/Scalers/Lumi/PionLT_replay_hms_helicity_scalers_%d_%d.report", RunNumber, MaxEvent));  // optional  
  analyzer->PrintReport("TEMPLATES/SHMS/SCALERS/phelscalers.template",
  			Form("/cache/hallc/c-pionlt/analysis/PionLT_Fullreplay_Analysis_Files_Pass1_2021/Scalers/Lumi/PionLT_replay_shms_helicity_scalers_%d_%d.report", RunNumber, MaxEvent));  // optional  
  }
  
  else if (RunNumber >= 14901 && RunNumber <= 17000) {
  // File to record accounting information for cuts
  analyzer->SetSummaryFile(Form("/cache/hallc/c-pionlt/analysis/PionLT_Fullreplay_Analysis_Files_Pass1_2022/SUMMARY_OUTPUT/Lumi/PionLT_SHMS_Lumi_summary_production_%d_%d.report", RunNumber, MaxEvent));  // optional
  // Start the actual analysis.
  analyzer->Process(run);
  // Create report file from template
  // analyzer->PrintReport("TEMPLATES/COIN/PRODUCTION/COIN_PROD.template",
  analyzer->PrintReport("TEMPLATES/COIN/PRODUCTION/PionLT_TEMP/PionLT_Offline_Luminosity.template",
  Form("/cache/hallc/c-pionlt/analysis/PionLT_Fullreplay_Analysis_Files_Pass1_2022/REPORT_OUTPUT/Lumi/PionLT_replay_SHMS_Lumi_%d_%d.report", RunNumber, MaxEvent));  // optional
  // Helicity scalers output
  analyzer->PrintReport("TEMPLATES/HMS/SCALERS/hhelscalers.template",
                        Form("/cache/hallc/c-pionlt/analysis/PionLT_Fullreplay_Analysis_Files_Pass1_2022/Scalers/Lumi/PionLT_replay_hms_helicity_scalers_%d_%d.report", RunNumber, MaxEvent));  // optional  
  analyzer->PrintReport("TEMPLATES/SHMS/SCALERS/phelscalers.template",
                        Form("/cache/hallc/c-pionlt/analysis/PionLT_Fullreplay_Analysis_Files_Pass1_2022/Scalers/Lumi/PionLT_replay_shms_helicity_scalers_%d_%d.report", RunNumber, MaxEvent));  // optional  
  }
*/
