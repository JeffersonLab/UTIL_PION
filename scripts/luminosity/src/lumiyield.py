...
def pid_cuts():
    ...
    ax.hist(tree["T_coin_pEDTM_tdcTimeRaw"],bins=c.bins(tree["T_coin_pEDTM_tdcTimeRaw"],10000,-1000,9000),label='no cut',histtype='step',alpha=0.5, stacked=True, fill=True)
