...
def plot_yield():
    ...
    plt.ylim(0.925,1.075)
    plt.plot([0,70], [1,1], 'r-',zorder=2)
    plt.errorbar(yield_data["current"],yield_data["yieldRel_HMS_CPULT_notrack"],yerr=yield_data["yieldRel_HMS_CPULT_notrack"]*yield_data["uncern_"yieldRel_HMS_CPULT_notrack""],color='black',linestyle='None',zorder=3,label="_nolegend_")
    plt.scatter(yield_data["current"],yield_data["yieldRel_HMS_CPULT_notrack"],color='blue',zorder=4,label="_nolegend_")
    #    yield_data["m0_curr_HMS_notrack"] = linear_plot(yield_data["current"],yield_data["yieldRel_HMS_CPULT_notrack"],None,yield_data["uncern_"yieldRel_HMS_CPULT_notrack""])
    ...
    plt.ylim(0.925,1.075)
    plt.plot([0,(max(yield_data["rate_HMS"])/1000)+5], [1,1], 'r-',zorder=2)
    plt.errorbar(yield_data["rate_HMS"]/1000,yield_data["yieldRel_HMS_CPULT_notrack"],yerr=yield_data["yieldRel_HMS_CPULT_notrack"]*yield_data["uncern_"yieldRel_HMS_CPULT_notrack""],color='black',linestyle='None',zorder=3,label="_nolegend_")
    plt.scatter(yield_data["rate_HMS"]/1000,yield_data["yieldRel_HMS_CPULT_notrack"],color='blue',zorder=4,label="_nolegend_")
