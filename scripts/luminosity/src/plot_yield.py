...
def calc_yield():
    ...
    if(makeList("SHMS_PS")[0] == None or makeList("SHMS_PS")[0] == -1 or makeList("SHMS_PS").any() == 0):
        ...
        for i,curr in enumerate(yield_dict["current"]):
            ...
            yield_SHMS_scaler = (yield_dict["SHMS_scaler_accp"])/(makeList("charge")*makeList("curr_corr")*yield_dict["ELT2"])
    ...
    if(makeList("HMS_PS")[0] == None or makeList("HMS_PS")[0] == -1 or makeList("HMS_PS").any() == 0):
        ...
        for i,curr in enumerate(yield_dict["current"]):
            ...
            yield_HMS_scaler = (yield_dict["HMS_scaler_accp"])/(makeList("charge")*makeList("curr_corr")*yield_dict["ELT2"])
