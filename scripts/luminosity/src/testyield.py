...
out_f = "%s/UTIL_PION/scripts/luminosity/OUTPUTS/test_data.csv" % REPLAYPATH
...
report = "%s/UTIL_PION/REPORT_OUTPUT/Analysis/PionLT/Pion_replay_coin_production_%s_%s.report" % (REPLAYPATH,runNum,MaxEvent)
