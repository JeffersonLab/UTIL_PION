...
#legend12_pions = ROOT.TLegend(0.115, 0.835, 0.43, 0.9)
#legend12_pions.AddEntry("P_ngcer_npe_pions_uncut", "without cuts", "l")
#legend12_pions.AddEntry("P_ngcer_npe_pions_cut", "with cuts (acpt/RF/PID)", "l")
#legend12_pions.Draw("same")
c2_pions_pid.cd(4)
#
