...
P_ngcer_vs_hgcer_npe_pions_cut = ROOT.TH2D("P_ngcer_vs_hgcer_npe_pions_cut", "SHMS NGC npeSum vs SHMS HGC npeSum (RF_PID(HGC-AERO-NGC)_cut); SHMS_ngcer_npeSum; SHMS_hgcer_npeSum", 100, 0, 1, 100, 0, 50)
P_ngcer_vs_aero_npe_pions_cut = ROOT.TH2D("P_ngcer_vs_aero_npe_pions_cut", "SHMS NGC npeSum vs SHMS aero npeSum (RF_PID(HGC-AERO-NGC)_cut); SHMS_ngcer_npeSum; SHMS_aero_npeSum", 100, 0, 1, 100, 0, 50)
...
P_ngcer_vs_hgcer_npe_kaons_cut = ROOT.TH2D("P_ngcer_vs_hgcer_npe_kaons_cut", "SHMS NGC npeSum vs SHMS HGC npeSum (RF_PID(HGC-AERO-NGC)_cut); SHMS_ngcer_npeSum; SHMS_hgcer_npeSum", 100, 0, 1, 100, 0, 0.5)
P_ngcer_vs_aero_npe_kaons_cut = ROOT.TH2D("P_ngcer_vs_aero_npe_kaons_cut", "SHMS NGC npeSum vs SHMS aero npeSum (RF_PID(HGC-AERO-NGC)_cut); SHMS_ngcer_npeSum; SHMS_aero_npeSum", 100, 0, 1, 100, 0, 50)
...
P_ngcer_vs_hgcer_npe_protons_cut = ROOT.TH2D("P_ngcer_vs_hgcer_npe_protons_cut", "SHMS NGC npeSum vs SHMS HGC npeSum (RF_PID(HGC-AERO-NGC)_cut); SHMS_ngcer_npeSum; SHMS_hgcer_npeSum", 100, 0, 1, 100, 0, 0.5)
P_ngcer_vs_aero_npe_protons_cut = ROOT.TH2D("P_ngcer_vs_aero_npe_protons_cut", "SHMS NGC npeSum vs SHMS aero npeSum (RF_PID(HGC-AERO-NGC)_cut); SHMS_ngcer_npeSum; SHMS_aero_npeSum", 100, 0, 1, 100, 0, 0.5)
