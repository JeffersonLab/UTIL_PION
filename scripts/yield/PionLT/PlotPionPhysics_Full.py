...
OUTPATH = "%s/UTIL_PION/OUTPUT/Analysis/PID" % REPLAYPATH        # Output folder location                                                                                                     
...
if (FilenameOverride == False):
    Pion_Analysis_Distributions = "%s/%s_%s_Full_Pion_Analysis_Distributions_RF_PID(HGC-AERO-NGC).pdf" % (OUTPATH, runNum, MaxEvent)
    ...
    Pion_Analysis_Distributions = "%s/%s_Full_Pion_Analysis_Distributions_RF_PID(HGC-AERO-NGC).pdf" %(OUTPATH, (FilenameOverride.split("_Analysed_Data.root",1)[0]))
    Kaon_Analysis_Distributions = "%s/%s_Full_Kaon_Analysis_Distributions_RF_PID(HGC-AERO-NGC).pdf" %(OUTPATH, (FilenameOverride.split("_Analysed_Data.root",1)[0]))
    Proton_Analysis_Distributions = "%s/%s_Full_Proton_Analysis_Distributions_RF_PID(HGC-AERO-NGC).pdf" %(OUTPATH, (FilenameOverride.split("_Analysed_Data.root",1)[0]))
...
P_hgcer_npe_pions_uncut = ROOT.TH1D("P_hgcer_npe_pions_uncut", "SHMS HGC npeSum (RF_PID(HGC-AERO-NGC)_cut); SHMS_hgcer_npeSum; Counts", 200, 0, 50)
...
P_aero_npe_pions_uncut = ROOT.TH1D("P_aero_npe_pions_uncut", "SHMS aero npeSum (RF_PID(HGC-AERO-NGC)_cut); SHMS_aero_npeSum; Counts", 200, 0, 50)
...
P_ngcer_npe_pions_uncut = ROOT.TH1D("P_ngcer_npe_pions_uncut", "SHMS NGC npeSum (RF_PID(HGC-AERO-NGC)_cut); SHMS_ngcer_npeSum; Counts", 200, 0, 50)
...
P_hgcer_npe_pions_cut = ROOT.TH1D("P_hgcer_npe_pions_cut", "SHMS HGC npeSum (RF_PID(HGC-AERO-NGC)_cut); SHMS_hgcer_npeSum; Counts", 200, 0, 50)
P_xhgcer_pions_cut = ROOT.TH1D("P_xhgcer_pions_cut", "SHMS HGC xAtCer (RF_PID(HGC-AERO-NGC)_cut); SHMS_hgcer_xAtCer; Counts", 200, -40, 30)
P_yhgcer_pions_cut = ROOT.TH1D("P_yhgcer_pions_cut", "SHMS HGC yAtCer (RF_PID(HGC-AERO-NGC)_cut); SHMS_hgcer_yAtCer; Counts", 200, -30, 30)
P_aero_npe_pions_cut = ROOT.TH1D("P_aero_npe_pions_cut", "SHMS aero npeSum (RF_PID(HGC-AERO-NGC)_cut); SHMS_aero_npeSum; Counts", 200, 0, 50)
...
P_ngcer_npe_pions_cut = ROOT.TH1D("P_ngcer_npe_pions_cut", "SHMS NGC npeSum (RF_PID(HGC-AERO-NGC)_cut); SHMS_ngcer_npeSum; Counts", 200, 0, 50)
...
P_MMpi_pions_cut = ROOT.TH1D("P_MMpi_pions_cut", "Missing Mass (RF_PID(HGC-AERO-NGC)_cut); MM_{#pi}; Counts", 200, 0.5, 1.8)
P_RFTime_pions_cut = ROOT.TH1D("P_RFTime_pions_cut", "SHMS RFTime (RF_PID(HGC-AERO-NGC)_cut); SHMS_RFTime; Counts", 200, 0, 4)
ePiCoinTime_pions_cut = ROOT.TH1D("ePiCoinTime_pions_cut", "Electron-Pion CTime (RF_PID(HGC-AERO-NGC)_cut); e #pi Coin_Time; Counts", 200, -50, 50)
...
P_MMpi_pions_cut_randm_sub = ROOT.TH1D("P_MMpi_pions_cut_randm_sub", "Missing Mass Rndm Sub (RF_PID(HGC-AERO-NGC)_cut); MM_{#pi}; Counts", 200, 0.5, 1.8)
...
P_hgcer_npe_kaons_uncut = ROOT.TH1D("P_hgcer_npe_kaons_uncut", "SHMS HGC npeSum (RF_PID(HGC-AERO-NGC)_cut); SHMS_hgcer_npeSum; Counts", 200, 0, 50)
...
P_aero_npe_kaons_uncut = ROOT.TH1D("P_aero_npe_kaons_uncut", "SHMS aero npeSum (RF_PID(HGC-AERO-NGC)_cut); SHMS_aero_npeSum; Counts", 200, 0, 50)
...
P_ngcer_npe_kaons_uncut = ROOT.TH1D("P_ngcer_npe_kaons_uncut", "SHMS NGC npeSum (RF_PID(HGC-AERO-NGC)_cut); SHMS_ngcer_npeSum; Counts", 200, 0, 50)
...
P_hgcer_npe_kaons_cut = ROOT.TH1D("P_hgcer_npe_kaons_cut", "SHMS HGC npeSum (RF_PID(HGC-AERO-NGC)_cut); SHMS_hgcer_npeSum; Counts", 200, 0, 50)
...
P_aero_npe_kaons_cut = ROOT.TH1D("P_aero_npe_kaons_cut", "SHMS aero npeSum (RF_PID(HGC-AERO-NGC)_cut); SHMS_aero_npeSum; Counts", 200, 0, 50)
...
P_ngcer_npe_kaons_cut = ROOT.TH1D("P_ngcer_npe_kaons_cut", "SHMS NGC npeSum (RF_PID(HGC-AERO-NGC)_cut); SHMS_ngcer_npeSum; Counts", 200, 0, 50)
...
P_MMK_kaons_cut = ROOT.TH1D("P_MMK_kaons_cut", "Missing Mass (RF_PID(HGC-AERO-NGC)_cut); MM_{K}; Counts", 200, 0.5, 1.8)
P_RFTime_kaons_cut = ROOT.TH1D("P_RFTime_kaons_cut", "SHMS RFTime (RF_PID(HGC-AERO-NGC)_cut); SHMS_RFTime; Counts", 200, 0, 4)
eKCoinTime_kaons_cut = ROOT.TH1D("eKCoinTime_kaons_cut", "Electron-Kaon CTime (RF_PID(HGC-AERO-NGC)_cut); e K Coin_Time; Counts", 200, -50, 50)
...
P_MMK_kaons_cut_randm_sub = ROOT.TH1D("P_MMK_kaons_cut_randm_sub", "Missing Mass Rndm Sub (RF_PID(HGC-AERO-NGC)_cut); MM_{K}; Counts", 200, 0.5, 1.8)
...
P_hgcer_npe_protons_uncut = ROOT.TH1D("P_hgcer_npe_protons_uncut", "SHMS HGC npeSum (RF_PID(HGC-AERO-NGC)_cut); SHMS_hgcer_npeSum; Counts", 200, 0, 50)
...
P_aero_npe_protons_uncut = ROOT.TH1D("P_aero_npe_protons_uncut", "SHMS aero npeSum (RF_PID(HGC-AERO-NGC)_cut); SHMS_aero_npeSum; Counts", 200, 0, 50)
...
P_ngcer_npe_protons_uncut = ROOT.TH1D("P_ngcer_npe_protons_uncut", "SHMS NGC npeSum (RF_PID(HGC-AERO-NGC)_cut); SHMS_ngcer_npeSum; Counts", 200, 0, 50)
...
P_MMp_protons_uncut = ROOT.TH1D("P_MMp_protons_uncut", "MIssing Mass; MM_{p}; Counts", 200, 0.5, 1.8)
P_RFTime_protons_uncut = ROOT.TH1D("P_RFTime_protons_uncut", "SHMS RFTime; SHMS_RFTime; Counts", 200, 0, 4)
epCoinTime_protons_uncut = ROOT.TH1D("epCoinTime_protons_uncut", "Electron-kaon CTime (no cut); e p Coin_Time; Counts", 200, -50, 50)
...
P_hgcer_npe_protons_cut = ROOT.TH1D("P_hgcer_npe_protons_cut", "SHMS HGC npeSum (RF_PID(HGC-AERO-NGC)_cut); SHMS_hgcer_npeSum; Counts", 200, 0, 50)
...
P_aero_npe_protons_cut = ROOT.TH1D("P_aero_npe_protons_cut", "SHMS aero npeSum (RF_PID(HGC-AERO-NGC)_cut); SHMS_aero_npeSum; Counts", 200, 0, 50)
...
P_ngcer_npe_protons_cut = ROOT.TH1D("P_ngcer_npe_protons_cut", "SHMS NGC npeSum (RF_PID(HGC-AERO-NGC)_cut); SHMS_ngcer_npeSum; Counts", 200, 0, 50)
...
P_MMp_protons_cut = ROOT.TH1D("P_MMp_protons_cut", "Missing Mass (RF_PID(HGC-AERO-NGC)_cut); MM_{p}; Counts", 200, 0.5, 1.8)
P_RFTime_protons_cut = ROOT.TH1D("P_RFTime_protons_cut", "SHMS RFTime (RF_PID(HGC-AERO-NGC)_cut); SHMS_RFTime; Counts", 200, 0, 4)
epCoinTime_protons_cut = ROOT.TH1D("epCoinTime_protons_cut", "Electron-Proton CTime (RF_PID(HGC-AERO-NGC)_cut); e p Coin_Time; Counts", 200, -50, 50)
...
P_MMp_protons_cut_randm_sub = ROOT.TH1D("P_MMp_protons_cut_randm_sub", "Missing Mass Rndm Sub (RF_PID(HGC-AERO-NGC)_cut); MM_{p}; Counts", 200, 0.5, 1.8)
...
P_hgcer_vs_aero_npe_pions_cut = ROOT.TH2D("P_hgcer_vs_aero_npe_pions_cut", "SHMS HGC npeSum vs SHMS aero npeSum (RF_PID(HGC-AERO-NGC)_cut); SHMS_hgcer_npeSum; SHMS_aero_npeSum", 100, 0, 50, 100, 0, 50)
ePiCoinTime_vs_MMpi_pions_cut = ROOT.TH2D("ePiCoinTime_vs_MMpi_pions_cut","Electron-Pion CTime vs Missing Mass (RF_PID(HGC-AERO-NGC)_cut); e #pi Coin_Time; MM_{#pi}", 100, -2, 2, 100, 0, 2)
...
ePiCoinTime_vs_beta_pions_cut = ROOT.TH2D("ePiCoinTime_vs_beta_pions_cut", "Electron-Pion CTime vs SHMS #beta (RF_PID(HGC-AERO-NGC)_cut); e #pi Coin_Time; SHMS_#beta", 100, -2, 2, 100, 0.6, 1.4)
P_RFTime_vs_MMpi_pions_cut = ROOT.TH2D("P_RFTime_vs_MMpi_pions_cut", "SHMS RFTime vs Missing Mass (RF_PID(HGC-AERO-NGC)_cut); SHMS_RFTime_Dist; MM_{#pi}", 100, 0, 4, 100, 0, 2)
...
P_ngcer_vs_hgcer_npe_pions_cut = ROOT.TH2D("P_ngcer_vs_hgcer_npe_pions_cut", "SHMS NGC npeSum vs SHMS HGC npeSum (RF_PID(HGC-AERO-NGC)_cut); SHMS_ngcer_npeSum; SHMS_hgcer_npeSum", 100, 0, 50, 100, 0, 50)
P_ngcer_vs_aero_npe_pions_cut = ROOT.TH2D("P_ngcer_vs_aero_npe_pions_cut", "SHMS NGC npeSum vs SHMS aero npeSum (RF_PID(HGC-AERO-NGC)_cut); SHMS_ngcer_npeSum; SHMS_aero_npeSum", 100, 0, 50, 100, 0, 50)
...
P_MMpi_vs_beta_pions_cut = ROOT.TH2D("P_MMpi_vs_beta_pions_cut", "Missing Mass vs SHMS #beta (RF_PID(HGC-AERO-NGC)_cut); MM_{#pi}; SHMS_#beta", 100, 0, 2, 200, 0, 2)
...
P_hgcer_vs_aero_npe_kaons_cut = ROOT.TH2D("P_hgcer_vs_aero_npe_kaons_cut", "SHMS HGC npeSum vs SHMS aero npeSum (RF_PID(HGC-AERO-NGC)_cut); SHMS_hgcer_npeSum; SHMS_aero_npeSum", 100, 0, 0.5, 100, 0, 50)
eKCoinTime_vs_MMK_kaons_cut = ROOT.TH2D("eKCoinTime_vs_MMK_kaons_cut","Electron-Kaon CTime vs Missing Mass (RF_PID(HGC-AERO-NGC)_cut); e K Coin_Time; MM_{K}", 100, -2, 2, 100, 0, 2)
...
eKCoinTime_vs_beta_kaons_cut = ROOT.TH2D("eKCoinTime_vs_beta_kaons_cut", "Electron-Kaon CTime vs SHMS #beta (RF_PID(HGC-AERO-NGC)_cut); e K Coin_Time; SHMS_#beta", 100, -2, 2, 100, 0.6, 1.4)
P_RFTime_vs_MMK_kaons_cut = ROOT.TH2D("P_RFTime_vs_MMK_kaons_cut", "SHMS RFTime vs Missing Mass (RF_PID(HGC-AERO-NGC)_cut); SHMS_RFTime_Dist; MM_{K}", 100, 0, 4, 100, 0, 2)
...
P_ngcer_vs_hgcer_npe_kaons_cut = ROOT.TH2D("P_ngcer_vs_hgcer_npe_kaons_cut", "SHMS NGC npeSum vs SHMS HGC npeSum (RF_PID(HGC-AERO-NGC)_cut); SHMS_ngcer_npeSum; SHMS_hgcer_npeSum", 100, 0, 50, 100, 0, 0.5)
P_ngcer_vs_aero_npe_kaons_cut = ROOT.TH2D("P_ngcer_vs_aero_npe_kaons_cut", "SHMS NGC npeSum vs SHMS aero npeSum (RF_PID(HGC-AERO-NGC)_cut); SHMS_ngcer_npeSum; SHMS_aero_npeSum", 100, 0, 50, 100, 0, 50)
...
P_MMK_vs_beta_kaons_cut = ROOT.TH2D("P_MMK_vs_beta_kaons_cut", "Missing Mass vs SHMS #beta (RF_PID(HGC-AERO-NGC)_cut); MM_{K}; SHMS_#beta", 100, 0, 2, 200, 0, 2)
...
P_hgcer_vs_aero_npe_protons_cut = ROOT.TH2D("P_hgcer_vs_aero_npe_protons_cut", "SHMS HGC npeSum vs SHMS aero npeSum (RF_PID(HGC-AERO-NGC)_cut); SHMS_hgcer_npeSum; SHMS_aero_npeSum", 100, 0, 0.5, 100, 0, 0.5)
epCoinTime_vs_MMp_protons_cut = ROOT.TH2D("epCoinTime_vs_MMp_protons_cut","Electron-Proton CTime vs Missing Mass (RF_PID(HGC-AERO-NGC)_cut); e p Coin_Time; MM_{p}", 100, -2, 2, 100, 0, 2)
...
epCoinTime_vs_beta_protons_cut = ROOT.TH2D("epCoinTime_vs_beta_protons_cut", "Electron-Proton CTime vs SHMS #beta (RF_PID(HGC-AERO-NGC)_cut); e p Coin_Time; SHMS_#beta", 100, -2, 2, 100, 0.6, 1.4)
P_RFTime_vs_MMp_protons_cut = ROOT.TH2D("P_RFTime_vs_MMp_protons_cut", "SHMS RFTime vs Missing Mass (RF_PID(HGC-AERO-NGC)_cut); SHMS_RFTime_Dist; MM_{p}", 100, 0, 4, 100, 0, 2)
...
P_ngcer_vs_hgcer_npe_protons_cut = ROOT.TH2D("P_ngcer_vs_hgcer_npe_protons_cut", "SHMS NGC npeSum vs SHMS HGC npeSum (RF_PID(HGC-AERO-NGC)_cut); SHMS_ngcer_npeSum; SHMS_hgcer_npeSum", 100, 0, 50, 100, 0, 0.5)
P_ngcer_vs_aero_npe_protons_cut = ROOT.TH2D("P_ngcer_vs_aero_npe_protons_cut", "SHMS NGC npeSum vs SHMS aero npeSum (RF_PID(HGC-AERO-NGC)_cut); SHMS_ngcer_npeSum; SHMS_aero_npeSum", 100, 0, 50, 100, 0, 0.5)
...
P_MMp_vs_beta_protons_cut = ROOT.TH2D("P_MMp_vs_beta_protons_cut", "Missing Mass vs SHMS #beta (RF_PID(HGC-AERO-NGC)_cut); MM_{p}; SHMS_#beta", 100, 0, 2, 200, 0, 2)
...
P_HGC_xy_npe_pions_cut = ROOT.TH3D("P_HGC_xy_npe_pions_cut", "SHMS HGC NPE as fn of yAtCer vs SHMS HGC xAtCer (RF_PID(HGC-AERO-NGC)_cut); HGC_yAtCer(cm); HGC_xAtCer(cm); NPE", 100, -50, 50, 100, -50, 50, 100, 0.1 , 50)
P_Aero_xy_npe_pions_cut = ROOT.TH3D("P_Aero_xy_npe_pions_cut", "SHMS Aerogel NPE as fn of yAtCer vs xAtCer (RF_PID(HGC-AERO-NGC)_cut); Aero_yAtCer(cm); Aero_xAtCer(cm); NPE", 100, -50, 50, 100, -50, 50, 100, 0.1 , 50)
P_NGC_xy_npe_pions_cut = ROOT.TH3D("P_NGC_xy_npe_pions_cut", "SHMS NGC NPE as fn of yAtCer vs xAtCer (RF_PID(HGC-AERO-NGC)_cut); NGC_yAtCer(cm); NGC_xAtCer(cm); NPE", 100, -50, 50, 100, -50, 50, 100, 0.1 , 50)
...
P_HGC_xy_npe_kaons_cut = ROOT.TH3D("P_HGC_xy_npe_kaons_cut", "SHMS HGC NPE as fn of yAtCer vs SHMS HGC xAtCer (RF_PID(HGC-AERO-NGC)_cut); HGC_yAtCer(cm); HGC_xAtCer(cm); NPE", 100, -50, 50, 100, -50, 50, 100, 0.1 , 50)
P_Aero_xy_npe_kaons_cut = ROOT.TH3D("P_Aero_xy_npe_kaons_cut", "SHMS Aerogel NPE as fn of yAtCer vs xAtCer (RF_PID(HGC-AERO-NGC)_cut); Aero_yAtCer(cm); Aero_xAtCer(cm); NPE", 100, -50, 50, 100, -50, 50, 100, 0.1 , 50)
P_NGC_xy_npe_kaons_cut = ROOT.TH3D("P_NGC_xy_npe_kaons_cut", "SHMS NGC NPE as fn of yAtCer vs xAtCer (RF_PID(HGC-AERO-NGC)_cut); NGC_yAtCer(cm); NGC_xAtCer(cm); NPE", 100, -50, 50, 100, -50, 50, 100, 0.1 , 50)
...
P_HGC_xy_npe_protons_cut = ROOT.TH3D("P_HGC_xy_npe_protons_cut", "SHMS HGC NPE as fn of yAtCer vs SHMS HGC xAtCer (RF_PID(HGC-AERO-NGC)_cut); HGC_yAtCer(cm); HGC_xAtCer(cm); NPE", 100, -50, 50, 100, -50, 50, 100, 0.1 , 50)
P_Aero_xy_npe_protons_cut = ROOT.TH3D("P_Aero_xy_npe_protons_cut", "SHMS Aerogel NPE as fn of yAtCer vs xAtCer (RF_PID(HGC-AERO-NGC)_cut); Aero_yAtCer(cm); Aero_xAtCer(cm); NPE", 100, -50, 50, 100, -50, 50, 100, 0.1 , 50)
P_NGC_xy_npe_protons_cut = ROOT.TH3D("P_NGC_xy_npe_protons_cut", "SHMS NGC NPE as fn of yAtCer vs xAtCer (RF_PID(HGC-AERO-NGC)_cut); NGC_yAtCer(cm); NGC_xAtCer(cm); NPE", 100, -50, 50, 100, -50, 50, 100, 0.1 , 50)
...
legend6_pions.AddEntry("P_hgcer_npe_pions_cut", "with cuts (RF_PID(HGC-AERO-NGC)_Accpt)", "l")
...
legend7_pions.AddEntry("P_aero_npe_pions_cut", "with cuts (RF_PID(HGC-AERO-NGC)_Accpt)", "l")
...
legend4_pions.AddEntry("P_RFTime_pions_cut", "with cuts (RF_PID(HGC-AERO-NGC)_Accpt)", "l")
legend4_pions.Draw("same")
c1_pions_RF.cd(2)
P_RFTime_pions_cut.SetLineColor(2)
P_RFTime_pions_cut.Draw()
c1_pions_RF.cd(3)
gPad.SetLogz()
...
legend9_pions.AddEntry("ePiCoinTime_pions_cut_prompt", "CT_prompt with cuts (acpt/RF/PID(HGC-AERO-NGC))", "l")
legend9_pions.AddEntry("ePiCoinTime_pions_cut_randm", "CT_randoms with cuts (acpt/RF/PID(HGC-AERO-NGC))", "l")
...
legend10_pions.AddEntry("ePiCoinTime_pions_cut", "CT_with cuts (acpt/RF/PID(HGC-AERO-NGC))", "l")
legend10_pions.AddEntry("ePiCoinTime_pions_cut_prompt", "CT_prompt with cuts (acpt/RF/PID(HGC-AERO-NGC))", "l")
legend10_pions.AddEntry("ePiCoinTime_pions_cut_randm", "CT_randoms with cuts (acpt/RF/PID(HGC-AERO-NGC))", "l")
...
legend11_pions.AddEntry("P_MMpi_pions_cut", "MM with cuts (acpt/RF/PID(HGC-AERO-NGC))", "l")
legend11_pions.AddEntry("P_MMpi_pions_cut_prompt", "MM_prompt with cuts (acpt/RF/PID(HGC-AERO-NGC))", "l")
legend11_pions.AddEntry("P_MMpi_pions_cut_randm", "MM_randoms with cuts (acpt/RF/PID(HGC-AERO-NGC))", "l")
...
legend17_kaons.AddEntry("P_hgcer_npe_kaons_cut", "with cuts (acpt/RF/PID(HGC-AERO-NGC))", "l")
...
legend18_kaons.AddEntry("P_aero_npe_kaons_cut", "with cuts (acpt/RF/PID(HGC-AERO-NGC))", "l")
...
legend15_kaons.AddEntry("P_RFTime_kaons_cut", "with cuts (acpt/RF/PID(HGC-AERO-NGC))", "l")
legend15_kaons.Draw("same")
c1_kaons_RF.cd(2)
P_RFTime_kaons_cut.SetLineColor(2)
P_RFTime_kaons_cut.Draw()
#legend16_kaons = ROOT.TLegend(0.115, 0.835, 0.415, 0.9)
#legend16_kaons.AddEntry("P_RFTime_kaons_cut_RF", "RF_cuts (acpt/PID(HGC-AERO-NGC))", "l")
#legend16_kaons.AddEntry("P_RFTime_kaons_cut", "RF_cuts (acpt/PID(HGC-AERO-NGC))", "l")
...
c3_kaons_pid = TCanvas("c3_kaons_pid", "Electron-Kaon Aero/HGC/NGC PID(HGC-AERO-NGC) Distributions", 100, 0, 1000, 900)
...
legend20_kaons.AddEntry("eKCoinTime_kaons_cut_prompt", "CT_prompt with cuts (acpt/RF/PID(HGC-AERO-NGC))", "l")
legend20_kaons.AddEntry("eKCoinTime_kaons_cut_randm", "CT_randoms with cuts (acpt/RF/PID(HGC-AERO-NGC))", "l")
...
legend21_kaons.AddEntry("eKCoinTime_kaons_cut", "CT_with cuts (acpt/RF/PID(HGC-AERO-NGC))", "l")
legend21_kaons.AddEntry("eKCoinTime_kaons_cut_prompt", "CT_prompt with cuts (acpt/RF/PID(HGC-AERO-NGC))", "l")
legend21_kaons.AddEntry("eKCoinTime_kaons_cut_randm", "CT_randoms with cuts (acpt/RF/PID(HGC-AERO-NGC))", "l")
...
legend22_kaons.AddEntry("P_MMK_kaons_cut", "MM with cuts (acpt/RF/PID(HGC-AERO-NGC))", "l")
legend22_kaons.AddEntry("P_MMK_kaons_cut_prompt", "MM_prompt with cuts (acpt/RF/PID(HGC-AERO-NGC))", "l")
legend22_kaons.AddEntry("P_MMK_kaons_cut_randm", "MM_randoms with cuts (acpt/RF/PID(HGC-AERO-NGC))", "l")
...
legend28_protons.AddEntry("P_hgcer_npe_protons_cut", "with cuts (acpt/RF/PID(HGC-AERO-NGC))", "l")
...
legend29_protons.AddEntry("P_aero_npe_protons_cut", "with cuts (acpt/RF/PID(HGC-AERO-NGC))", "l")
...
legend26_protons.AddEntry("P_RFTime_protons_cut", "with cuts (acpt/RF/PID(HGC-AERO-NGC))", "l")
legend26_protons.Draw("same")
c1_protons_RF.cd(2)
P_RFTime_protons_cut.SetLineColor(2)
P_RFTime_protons_cut.Draw()
#legend27_protons = ROOT.TLegend(0.115, 0.835, 0.415, 0.9)
#legend27_protons.AddEntry("P_RFTime_protons_cut_RF", "RF_cuts (acpt/PID(HGC-AERO-NGC))", "l")
#legend27_protons.AddEntry("P_RFTime_protons_cut", "RF_cuts (acpt/PID(HGC-AERO-NGC))", "l")
...
c3_protons_pid = TCanvas("c3_protons_pid", "Electron-Proton Aero/HGC/NGC PID(HGC-AERO-NGC) Distributions", 100, 0, 1000, 900)
...
legend31_protons.AddEntry("epCoinTime_protons_cut_prompt", "CT_prompt with cuts (acpt/RF/PID(HGC-AERO-NGC))", "l")
legend31_protons.AddEntry("epCoinTime_protons_cut_randm", "CT_randoms with cuts (acpt/RF/PID(HGC-AERO-NGC))", "l")
...
legend32_protons.AddEntry("epCoinTime_protons_cut", "CT_with cuts (acpt/RF/PID(HGC-AERO-NGC))", "l")
legend32_protons.AddEntry("epCoinTime_protons_cut_prompt", "CT_prompt with cuts (acpt/RF/PID(HGC-AERO-NGC))", "l")
legend32_protons.AddEntry("epCoinTime_protons_cut_randm", "CT_randoms with cuts (acpt/RF/PID(HGC-AERO-NGC))", "l")
...
legend33_protons.AddEntry("P_MMp_protons_cut", "MM with cuts (acpt/RF/PID(HGC-AERO-NGC))", "l")
legend33_protons.AddEntry("P_MMp_protons_cut_prompt", "MM_prompt with cuts (acpt/RF/PID(HGC-AERO-NGC))", "l")
legend33_protons.AddEntry("P_MMp_protons_cut_randm", "MM_randoms with cuts (acpt/RF/PID(HGC-AERO-NGC))", "l")
