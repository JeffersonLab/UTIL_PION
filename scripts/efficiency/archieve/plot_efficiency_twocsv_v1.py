...
inp_f1 = UTILPATH+"/scripts/efficiency/OUTPUTS/PionLT_SHMS_HeePSing_HeePSing_efficiency_data_2024_03_02.csv"
inp_f2 = UTILPATH+"/scripts/efficiency/OUTPUTS/PionLT_SHMS_Lumi_LumiSing_efficiency_data_2024_03_02.csv"
...
plt.scatter(efficiency_data1["SHMS_EL-REAL_Trigger_Rate"],efficiency_data1["SHMS_Elec_SING_TRACK_EFF"],color='red',zorder=4)
...
plt.scatter(efficiency_data2["SHMS_EL-REAL_Trigger_Rate"],efficiency_data2["SHMS_Elec_SING_TRACK_EFF"],color='red',zorder=4)
...
plt.scatter(efficiency_data1["SHMS_Hodoscope_S1X_Rate"],efficiency_data1["SHMS_Elec_SING_TRACK_EFF"],color='red',zorder=4)
...
plt.scatter(efficiency_data2["SHMS_Hodoscope_S1X_Rate"],efficiency_data2["SHMS_Elec_SING_TRACK_EFF"],color='red',zorder=4)
plt.ylabel('Electron Tracking Efficiency', fontsize=12)
plt.xlabel('SHMS S1X HODO Rate [kHz]', fontsize=12)
plt.locator_params(axis='x', nbins=20) ### set number of bins for x axis only
plt.xticks(rotation=90)
plt.tight_layout(rect=[0,0.03,1,0.95])   
plt.savefig(UTILPATH+'/scripts/efficiency/OUTPUTS/plots/SHMS_Electron_EFF_vs_S1X_Rate.png')
...
plt.scatter(efficiency_data3["SHMS_3/4_Trigger_Rate"],efficiency_data3["SHMS_Pion_SING_TRACK_EFF"],color='blue',zorder=4)
...
plt.scatter(efficiency_data3["SHMS_Hodoscope_S1X_Rate"],efficiency_data3["SHMS_Pion_SING_TRACK_EFF"],color='blue',zorder=4)
plt.ylabel('Pion Tracking Efficiency', fontsize=12)
plt.xlabel('SHMS S1X HODO Rate [kHz]', fontsize=12)
plt.locator_params(axis='x', nbins=20) ### set number of bins for x axis only
plt.xticks(rotation=90)
plt.tight_layout(rect=[0,0.03,1,0.95])
plt.savefig(UTILPATH+'/scripts/efficiency/OUTPUTS/plots/SHMS_Pion_EFF_vs_S1X_Rate.png')
