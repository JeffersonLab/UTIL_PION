...
#plt.xlim(0,100)
#plt.ylim(0.9,1.02)
plt.errorbar(efficiency_data["Run_Number"],efficiency_data["SHMS_Aero_ALL_Pion_Eff"],yerr=efficiency_data["SHMS_Aero_ALL_Pion_Eff_ERROR"],color='black',linestyle='None',zorder=3)
plt.scatter(efficiency_data["Run_Number"],efficiency_data["SHMS_Aero_ALL_Pion_Eff"],color='blue',zorder=4)
...
#plt.xlim(0,100)
#plt.ylim(0.9,1.02)
plt.errorbar(efficiency_data["Run_Number"],efficiency_data["SHMS_HGC_ALL_Pion_Eff"],yerr=efficiency_data["SHMS_HGC_ALL_Pion_Eff_ERROR"],color='black',linestyle='None',zorder=3)
plt.scatter(efficiency_data["Run_Number"],efficiency_data["SHMS_HGC_ALL_Pion_Eff"],color='blue',zorder=4)
plt.ylabel('SHMS_HGC_ALL_Pion_Eff', fontsize=12)
plt.xlabel('Run Number', fontsize=12)
plt.title('SHMS %s-%s' % (int(min(efficiency_data["Run_Number"])),int(max(efficiency_data["Run_Number"]))), fontsize=12)

plt.tight_layout(rect=[0,0.03,1,0.95])   
plt.savefig(UTILPATH+'/scripts/efficiency/OUTPUTS/plots/SHMS_ALL_Pion_detctr_%s.png' % (ROOTPrefix.replace("replay_","")))
...
#plt.xlim(0,100)
#plt.ylim(0.9,1.02)
plt.errorbar(efficiency_data["Run_Number"],efficiency_data["SHMS_Aero_COIN_Pion_Eff"],yerr=efficiency_data["SHMS_Aero_COIN_Pion_Eff_ERROR"],color='black',linestyle='None',zorder=3)
plt.scatter(efficiency_data["Run_Number"],efficiency_data["SHMS_Aero_COIN_Pion_Eff"],color='blue',zorder=4)
plt.ylabel('SHMS_Aero_COIN_Pion_Eff', fontsize=12)
plt.xlabel('Run Number', fontsize=12)
plt.title('SHMS %s-%s' % (int(min(efficiency_data["Run_Number"])),int(max(efficiency_data["Run_Number"]))), fontsize=12)
...
#plt.xlim(0,100)
#plt.ylim(0.9,1.02)
plt.errorbar(efficiency_data["Run_Number"],efficiency_data["SHMS_HGC_COIN_Pion_Eff"],yerr=efficiency_data["SHMS_HGC_COIN_Pion_Eff_ERROR"],color='black',linestyle='None',zorder=3)
plt.scatter(efficiency_data["Run_Number"],efficiency_data["SHMS_HGC_COIN_Pion_Eff"],color='blue',zorder=4)
plt.ylabel('SHMS_HGC_COIN_Pion_Eff', fontsize=12)
plt.xlabel('Run Number', fontsize=12)
plt.title('SHMS %s-%s' % (int(min(efficiency_data["Run_Number"])),int(max(efficiency_data["Run_Number"]))), fontsize=12)

plt.tight_layout(rect=[0,0.03,1,0.95])
plt.savefig(UTILPATH+'/scripts/efficiency/OUTPUTS/plots/SHMS_COIN_Pion_detctr_%s.png' % (ROOTPrefix.replace("replay_","")))
...
plt.scatter(efficiency_data["Run_Number"],efficiency_data["SHMS_Aero_SING_Pion_Eff"],color='blue',zorder=4)
...
#plt.xlim(0,100)
#plt.ylim(0.9,1.02)
plt.errorbar(efficiency_data["Run_Number"],efficiency_data["SHMS_HGC_SING_Pion_Eff"],yerr=efficiency_data["SHMS_HGC_SING_Pion_Eff_ERROR"],color='black',linestyle='None',zorder=3)
plt.scatter(efficiency_data["Run_Number"],efficiency_data["SHMS_HGC_SING_Pion_Eff"],color='blue',zorder=4)
plt.ylabel('SHMS_HGC_SING_Pion_Eff', fontsize=12)
plt.xlabel('Run Number', fontsize=12)
plt.title('SHMS %s-%s' % (int(min(efficiency_data["Run_Number"])),int(max(efficiency_data["Run_Number"]))), fontsize=12)

plt.tight_layout(rect=[0,0.03,1,0.95])
plt.savefig(UTILPATH+'/scripts/efficiency/OUTPUTS/plots/SHMS_SING_Pion_detctr_%s.png' % (ROOTPrefix.replace("replay_","")))
