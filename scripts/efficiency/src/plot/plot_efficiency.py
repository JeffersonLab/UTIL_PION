...
plt.locator_params(axis='x', nbins=10) ### set number of bins for x axis only
plt.ylim(0.8, 1.02)
#plt.xlim(0, 756)
...
plt.ylabel('HMS Electron Tracking EFF', fontsize=12)
plt.xlabel('HMS EL-REAL Trigger Rate [kHz]', fontsize=12)
plt.locator_params(nbins=20) ### set number of bins for both axis
#plt.xticks(rotation=90)
plt.ylim(0.94, 1.04)
...
plt.ylabel('HMS Electron Tracking EFF', fontsize=12)
plt.xlabel('HMS Hodoscope S1X Rate [kHz]', fontsize=12)
plt.locator_params(nbins=20) ### set number of bins for both axis
#plt.xticks(rotation=90)
plt.grid(zorder=1)
plt.ylim(0.94, 1.04)
...
plt.ylabel('HMS Hodoscope 3/4 EFF', fontsize=12)
plt.xlabel('HMS EL-REAL Trigger Rate [kHz]', fontsize=12)
plt.locator_params(nbins=20) ### set number of bins for both axis
#plt.xticks(rotation=90)
plt.ylim(0.94, 1.04)
...
plt.ylabel('SHMS Pion Tracking EFF', fontsize=12)
plt.xlabel('SHMS 3/4 Trigger Rate [kHz]', fontsize=12)
plt.locator_params(nbins=20) ### set number of bins for both axis
#plt.xticks(rotation=90)
plt.ylim(0.90, 1.02)
...
plt.ylabel('SHMS Pion Tracking EFF', fontsize=12)
plt.xlabel('SHMS Hodoscope S1X Rate [kHz]', fontsize=12)
plt.locator_params(nbins=20) ### set number of bins for both axis
#plt.xticks(rotation=90)
plt.ylim(0.90, 1.02)
plt.xlim(0, 5500)
...
plt.ylabel('SHMS Hodoscope 3/4 EFF', fontsize=12)
plt.xlabel('SHMS 3/4 Trigger Rate [kHz]', fontsize=12)
plt.locator_params(nbins=20) ### set number of bins for both axis
#plt.xticks(rotation=90)
plt.ylim(0.9, 1.02)
...
plt.ylabel('SHMS Aerogel Pion EFF', fontsize=12)
plt.xlabel('Run Number', fontsize=12)
plt.locator_params(axis='x', nbins=20) ### set number of bins for x axis only
#plt.xticks(rotation=90)
#plt.xlim(6635, 7050)
