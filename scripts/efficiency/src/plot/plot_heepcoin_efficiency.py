...
#plt.xlim(0,100)
#plt.ylim(0.9,1.1)
plt.errorbar(efficiency_data["SHMS_3/4_Trigger_Rate"],efficiency_data["SHMS_Prot_COIN_TRACK_EFF"],yerr=efficiency_data["SHMS_Prot_COIN_TRACK_EFF_ERROR"],color='black',linestyle='None',zorder=3)
plt.scatter(efficiency_data["SHMS_3/4_Trigger_Rate"],efficiency_data["SHMS_Prot_COIN_TRACK_EFF"],color='blue',zorder=4)
plt.ylabel('SHMS_Prot_COIN_TRACK_EFF', fontsize=12)
plt.xlabel('SHMS 3/4 Trigger Rate [kHz]', fontsize=12)
plt.title('SHMS %s-%s' % (int(min(efficiency_data["Run_Number"])),int(max(efficiency_data["Run_Number"]))), fontsize=12)
...
plt.ylabel('EDTM', fontsize=12)
plt.xlabel('Run Number (HeePCoin)', fontsize=12)
plt.title('SHMS %s-%s' % (int(min(efficiency_data["Run_Number"])),int(max(efficiency_data["Run_Number"]))), fontsize=12)
...
#plt.xlim(0,100)
#plt.ylim(0.9,1.1)
plt.errorbar(efficiency_data["Run_Number"],efficiency_data["SHMS_Prot_SING_TRACK_EFF"],yerr=efficiency_data["SHMS_Prot_SING_TRACK_EFF_ERROR"],color='black',linestyle='None',zorder=3)
plt.scatter(efficiency_data["Run_Number"],efficiency_data["SHMS_Prot_SING_TRACK_EFF"],color='blue',zorder=4)
plt.ylabel('SHMS_Prot_SING_TRACK_EFF', fontsize=12)
plt.xlabel('Run Number (HeePCoin)', fontsize=12)
plt.title('SHMS %s-%s' % (int(min(efficiency_data["Run_Number"])),int(max(efficiency_data["Run_Number"]))), fontsize=12)
...
#plt.xlim(0,100)
#plt.ylim(0.9,1.1)
plt.errorbar(efficiency_data["Run_Number"],efficiency_data["SHMS_Prot_COIN_TRACK_EFF"],yerr=efficiency_data["SHMS_Prot_COIN_TRACK_EFF_ERROR"],color='black',linestyle='None',zorder=3)
plt.scatter(efficiency_data["Run_Number"],efficiency_data["SHMS_Prot_COIN_TRACK_EFF"],color='blue',zorder=4)
plt.ylabel('SHMS_Prot_COIN_TRACK_EFF', fontsize=12)
plt.xlabel('Run Number (HeePCoin)', fontsize=12)
plt.title('SHMS %s-%s' % (int(min(efficiency_data["Run_Number"])),int(max(efficiency_data["Run_Number"]))), fontsize=12)
...
#plt.xlim(0,100)
#plt.ylim(0.9,1.1)
plt.errorbar(efficiency_data["SHMS_Hodoscope_S1X_Rate"],efficiency_data["SHMS_Prot_COIN_TRACK_EFF"],yerr=efficiency_data["SHMS_Prot_COIN_TRACK_EFF_ERROR"],color='black',linestyle='None',zorder=3)
plt.scatter(efficiency_data["SHMS_Hodoscope_S1X_Rate"],efficiency_data["SHMS_Prot_COIN_TRACK_EFF"],color='blue',zorder=4)
plt.ylabel('SHMS_Prot_COIN_TRACK_EFF', fontsize=12)
plt.xlabel('SHMS S1X HODO Rate [kHz]', fontsize=12)
plt.title('SHMS %s-%s' % (int(min(efficiency_data["Run_Number"])),int(max(efficiency_data["Run_Number"]))), fontsize=12)
...
#plt.xlim(0,100)
#plt.ylim(0.9,1.1)
plt.errorbar(efficiency_data["HMS_EL-REAL_Trigger_Rate"],efficiency_data["HMS_Elec_COIN_TRACK_EFF"],yerr=efficiency_data["HMS_Elec_COIN_TRACK_EFF_ERROR"],color='black',linestyle='None',zorder=3)
plt.scatter(efficiency_data["HMS_EL-REAL_Trigger_Rate"],efficiency_data["HMS_Elec_COIN_TRACK_EFF"],color='red',zorder=4)
...
#plt.xlim(0,100)
#plt.ylim(0.9,1.1)
plt.errorbar(efficiency_data["HMS_Hodoscope_S1X_Rate"],efficiency_data["HMS_Elec_COIN_TRACK_EFF"],yerr=efficiency_data["HMS_Elec_COIN_TRACK_EFF_ERROR"],color='black',linestyle='None',zorder=3)
plt.scatter(efficiency_data["HMS_Hodoscope_S1X_Rate"],efficiency_data["HMS_Elec_COIN_TRACK_EFF"],color='red',zorder=4)
plt.ylabel('HMS_Elec_COIN_TRACK_EFF', fontsize=12)
plt.xlabel('HMS S1X HODO Rate [kHz]', fontsize=12)
plt.title('HMS %s-%s' % (int(min(efficiency_data["Run_Number"])),int(max(efficiency_data["Run_Number"]))), fontsize=12)
...
plt.scatter(efficiency_data["COIN_Trigger_Rate"],efficiency_data["Non_Scaler_EDTM_Live_Time"],color='green',zorder=4)
plt.ylabel('EDTM', fontsize=12)
...
#plt.xlim(0,100)
#plt.ylim(0.9,1.1)
plt.errorbar(efficiency_data["COIN_Trigger_Rate"],efficiency_data["HMS_Elec_COIN_TRACK_EFF"],yerr=efficiency_data["HMS_Elec_COIN_TRACK_EFF_ERROR"],color='black',linestyle='None',zorder=3)
plt.scatter(efficiency_data["COIN_Trigger_Rate"],efficiency_data["HMS_Elec_COIN_TRACK_EFF"],color='red',zorder=4)
plt.ylabel('HMS_Elec_COIN_TRACK_EFF', fontsize=12)
plt.xlabel('COIN Trigger Rate [kHz]', fontsize=12)
plt.title('HMS %s-%s' % (int(min(efficiency_data["Run_Number"])),int(max(efficiency_data["Run_Number"]))), fontsize=12)
...
#plt.xlim(0,100)
#plt.ylim(0.9,1.1)
plt.errorbar(efficiency_data["COIN_Trigger_Rate"],efficiency_data["SHMS_Prot_COIN_TRACK_EFF"],yerr=efficiency_data["SHMS_Prot_COIN_TRACK_EFF_ERROR"],color='black',linestyle='None',zorder=3)
plt.scatter(efficiency_data["COIN_Trigger_Rate"],efficiency_data["SHMS_Prot_COIN_TRACK_EFF"],color='blue',zorder=4)
plt.ylabel('SHMS_Prot_COIN_TRACK_EFF', fontsize=12)
plt.xlabel('COIN Trigger Rate [kHz]', fontsize=12)
plt.title('SHMS %s-%s' % (int(min(efficiency_data["Run_Number"])),int(max(efficiency_data["Run_Number"]))), fontsize=12)
...
plt.scatter(efficiency_data["COIN_Trigger_Rate"],efficiency_data["COIN_CPULT"],color='green',zorder=4)
plt.ylabel('COIN_CPULT', fontsize=12)
plt.xlabel('COIN Trigger Rate [kHz]', fontsize=12)
plt.title('COIN %s-%s' % (int(min(efficiency_data["Run_Number"])),int(max(efficiency_data["Run_Number"]))), fontsize=12)
