...
#plt.xlim(0,100)
#plt.ylim(0.9,1.1)
plt.errorbar(efficiency_data["SHMS_3/4_Trigger_Rate"],efficiency_data["SHMS_Pion_COIN_TRACK_EFF"],yerr=efficiency_data["SHMS_Pion_COIN_TRACK_EFF_ERROR"],color='black',linestyle='None',zorder=3)
plt.scatter(efficiency_data["SHMS_3/4_Trigger_Rate"],efficiency_data["SHMS_Pion_COIN_TRACK_EFF"],color='blue',zorder=4)
...
plt.ylabel('EDTM', fontsize=12)
plt.xlabel('Run Number (pTRIG6)', fontsize=12)
plt.title('SHMS %s-%s' % (int(min(efficiency_data["Run_Number"])),int(max(efficiency_data["Run_Number"]))), fontsize=12)
...
#plt.xlim(0,100)
#plt.ylim(0.9,1.1)
plt.errorbar(efficiency_data["SHMS_Hodoscope_S1X_Rate"],efficiency_data["SHMS_Pion_COIN_TRACK_EFF"],yerr=efficiency_data["SHMS_Pion_COIN_TRACK_EFF_ERROR"],color='black',linestyle='None',zorder=3)
plt.scatter(efficiency_data["SHMS_Hodoscope_S1X_Rate"],efficiency_data["SHMS_Pion_COIN_TRACK_EFF"],color='blue',zorder=4)
plt.ylabel('SHMS_Pion_COIN_TRACK_EFF', fontsize=12)
plt.xlabel('SHMS S1X HODO Rate [kHz]', fontsize=12)
plt.title('SHMS %s-%s' % (int(min(efficiency_data["Run_Number"])),int(max(efficiency_data["Run_Number"]))), fontsize=12)
...
#plt.xlim(0,100)
#plt.ylim(0.9,1.1)
plt.errorbar(efficiency_data["HMS_3/4_Trigger_Rate"],efficiency_data["Non_Scaler_EDTM_Live_Time"],yerr=efficiency_data["Non_Scaler_EDTM_Live_Time_ERROR"],color='black',linestyle='None',zorder=3)
plt.scatter(efficiency_data["HMS_3/4_Trigger_Rate"],efficiency_data["Non_Scaler_EDTM_Live_Time"],color='red',zorder=4)
plt.ylabel('EDTM', fontsize=12)
plt.xlabel('HMS 3/4 Trigger Rate [kHz]', fontsize=12)
...
#plt.xlim(0,100)
#plt.ylim(0.9,1.1)
plt.errorbar(efficiency_data["HMS_3/4_Trigger_Rate"],efficiency_data["HMS_Elec_SING_TRACK_EFF"],yerr=efficiency_data["HMS_Elec_SING_TRACK_EFF_ERROR"],color='black',linestyle='None',zorder=3)
plt.scatter(efficiency_data["HMS_3/4_Trigger_Rate"],efficiency_data["HMS_Elec_SING_TRACK_EFF"],color='red',zorder=4)
...
#plt.xlim(0,100)
#plt.ylim(0.9,1.1)
plt.errorbar(efficiency_data["HMS_3/4_Trigger_Rate"],efficiency_data["HMS_Elec_COIN_TRACK_EFF"],yerr=efficiency_data["HMS_Elec_COIN_TRACK_EFF_ERROR"],color='black',linestyle='None',zorder=3)
plt.scatter(efficiency_data["HMS_3/4_Trigger_Rate"],efficiency_data["HMS_Elec_COIN_TRACK_EFF"],color='red',zorder=4)
...
#plt.xlim(0,100)
#plt.ylim(0.9,1.1)
plt.scatter(efficiency_data["HMS_3/4_Trigger_Rate"],efficiency_data["HMS_Hodo_3_of_4_EFF"],color='red',zorder=4)
...
plt.ylabel('HMS_3/4_Trigger_Rate [kHz]', fontsize=12)
plt.xlabel('Run Number (pTRIG6)', fontsize=12)
plt.title('HMS %s-%s' % (int(min(efficiency_data["Run_Number"])),int(max(efficiency_data["Run_Number"]))), fontsize=12)
...
plt.ylabel('HMS 3/4 Trigger Rate [kHz]', fontsize=12)
plt.xlabel('COIN Trigger Rate [kHz]', fontsize=12)
plt.title('HMS %s-%s' % (int(min(efficiency_data["Run_Number"])),int(max(efficiency_data["Run_Number"]))), fontsize=12)
