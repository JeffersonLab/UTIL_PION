...
void makePlots ( TString rootFile, Int_t runNum, int NumEvents, int cutType ) 
{
	...
	th2_aeroXhgcer->GetXaxis()->SetNameTitle("Aerogel NPE");
	th2_aeroXhgcer->GetYaxis()->SetNameTitle("HGC NPE");
	...
	th2_ngcerXcal->GetXaxis()->SetNameTitle("NGC NPE");
	th2_ngcerXcal->GetYaxis()->SetNameTitle("Normalized Calorimeter Energy");
	th2_ngcerXcal->SetStats(0);
	
	th2_ngcerXaero = new TH2D("ngcerNpeSumVaeroNpeSum","ngcerNpeSumVaeroNpeSum", 100, 0.0, 35, 100, 0.0, 35);
	th2_ngcerXaero->GetXaxis()->SetNameTitle("NGC NPE");
	th2_ngcerXaero->GetYaxis()->SetNameTitle("Aerogel NPE");
	th2_ngcerXaero->SetStats(0);
	
	th2_ngcerXhgcer = new TH2D("ngcerNpeSumVhgcerNpeSum","ngcerNpeSumVhgcerNpeSum", 100, 0.0, 35, 100, 0.0, 35);
	th2_ngcerXhgcer->GetXaxis()->SetNameTitle("NGC NPE");
	th2_ngcerXhgcer->GetYaxis()->SetNameTitle("HGC NPE");
	...
	th1_hgcer_eff->GetXaxis()->SetNameTitle("#delta");
	th1_hgcer_eff->GetYaxis()->SetNameTitle("Efficiency");
	
	th1_aero_eff = new TH1D("aero_eff", "aero_eff", 120, -30.0, 30.0);
	th1_aero_eff->GetXaxis()->SetNameTitle("#delta");
	th1_aero_eff->GetYaxis()->SetNameTitle("Efficiency");
	th1_ngcer_eff = new TH1D("ngcer_eff", "ngcer_eff", 120, -30.0, 30.0);
	th1_ngcer_eff->GetXaxis()->SetNameTitle("#delta");
	th1_ngcer_eff->GetYaxis()->SetNameTitle("Efficiency");
    ...
    th2_fpXhgcer_eff2D->GetXaxis()->SetNameTitle("Focal Plane X");
    th2_fpXhgcer_eff2D->GetYaxis()->SetNameTitle("Focal Plane Y");
    ...
    th2_fpXngcer_eff2D->GetXaxis()->SetNameTitle("Focal Plane X");
    th2_fpXngcer_eff2D->GetYaxis()->SetNameTitle("Focal Plane Y");
    ...
    th2_fpXaero_eff2D->GetXaxis()->SetNameTitle("Focal Plane X");
    th2_fpXaero_eff2D->GetYaxis()->SetNameTitle("Focal Plane Y");
