...
for event in Uncut_Pion_Events_Data_tree:
    ...
    CTime_ePiCoinTime_ROC1_pions_data_uncut.Fill(event.CTime_ePiCoinTime_ROC1)
    ...
    CTime_ePiCoinTime_vs_MMpi_pions_uncut.Fill(event.CTime_ePiCoinTime_ROC1, event.MMpi)
    CTime_ePiCoinTime_vs_beta_pions_uncut.Fill(event.CTime_ePiCoinTime_ROC1, event.P_gtr_beta)
    P_RFTime_vs_MMpi_pions_uncut.Fill(event.P_RF_Dist, event.MMpi)
    CTime_ePiCoinTime_vs_RFTime_pions_uncut.Fill(event.CTime_ePiCoinTime_ROC1, event.P_RF_Dist)
...
for event in Cut_Pion_Events_Accpt_Data_tree:
    ...
    CTime_ePiCoinTime_vs_MMpi_pions_accpt_cut_all.Fill(event.CTime_ePiCoinTime_ROC1, event.MMpi)
    CTime_ePiCoinTime_vs_beta_pions_accpt_cut_all.Fill(event.CTime_ePiCoinTime_ROC1, event.P_gtr_beta)
    P_RFTime_vs_MMpi_pions_accpt_cut_all.Fill(event.P_RF_Dist, event.MMpi)
    CTime_ePiCoinTime_vs_RFTime_pions_accpt_cut_all.Fill(event.CTime_ePiCoinTime_ROC1, event.P_RF_Dist)
...
#    SHMS_PID_Cut = (event.P_aero_npeSum > P_aero_npeSum_cut_value)
    ...
    if (HMS_PID_Cut & SHMS_PID_Cut):
        ...
        CTime_ePiCoinTime_vs_MMpi_pions_prompt_cut_all.Fill(event.CTime_ePiCoinTime_ROC1, event.MMpi)
        CTime_ePiCoinTime_vs_beta_pions_prompt_cut_all.Fill(event.CTime_ePiCoinTime_ROC1, event.P_gtr_beta)
        P_RFTime_vs_MMpi_pions_prompt_cut_all.Fill(event.P_RF_Dist, event.MMpi)
        CTime_ePiCoinTime_vs_RFTime_pions_prompt_cut_all.Fill(event.CTime_ePiCoinTime_ROC1, event.P_RF_Dist)
...
#    SHMS_PID_Cut = (event.P_aero_npeSum > P_aero_npeSum_cut_value)
    ...
    if (HMS_PID_Cut & SHMS_PID_Cut):
        ...
        CTime_ePiCoinTime_ROC1_pions_data_random_unsub_cut_all.Fill(event.CTime_ePiCoinTime_ROC1)
        ...
        CTime_ePiCoinTime_vs_MMpi_pions_random_cut_all.Fill(event.CTime_ePiCoinTime_ROC1, event.MMpi)
        CTime_ePiCoinTime_vs_beta_pions_random_cut_all.Fill(event.CTime_ePiCoinTime_ROC1, event.P_gtr_beta)
        P_RFTime_vs_MMpi_pions_random_cut_all.Fill(event.P_RF_Dist, event.MMpi)
        CTime_ePiCoinTime_vs_RFTime_pions_random_cut_all.Fill(event.CTime_ePiCoinTime_ROC1, event.P_RF_Dist)
...
#    SHMS_PID_Cut = (event.P_aero_npeSum > P_aero_npeSum_cut_value)
    SHMS_PID_Cut = (event.P_RF_Dist > P_RF_Dist_low_cut_value) & (event.P_RF_Dist < P_RF_Dist_high_cut_value) & (event.P_aero_npeSum > P_aero_npeSum_cut_value)
    if (HMS_PID_Cut & SHMS_PID_Cut):
       CTime_ePiCoinTime_ROC1_pions_data_pid_cut_all.Fill(event.CTime_ePiCoinTime_ROC1)
...
# Find the x position of maxima
max_bin_CT = CTime_ePiCoinTime_ROC1_pions_data_prompt_cut_all.GetMaximumBin()
x_max_CT = CTime_ePiCoinTime_ROC1_pions_data_prompt_cut_all.GetBinCenter(max_bin_CT)
print(f"X position of CT maximum: {x_max_CT}")
...
CTime_ePiCoinTime_vs_RFTime_pions_cut_all.GetYaxis().SetRangeUser(-0.5, 2.0)
