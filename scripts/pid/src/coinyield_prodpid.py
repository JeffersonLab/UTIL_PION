...
cut_f = '/DB/CUTS/run_type/coin_prod.cuts.acceptcoin'

# defining Cuts
#cuts = ["coin_ep_cut_all_RF", "coin_ep_cut_prompt_RF", "coin_ep_cut_rand_RF"]
cuts = ["coin_epi_cut_all_noRF", "coin_epi_cut_prompt_noRF", "coin_epi_cut_rand_noRF"]
...
def coin_pions():
    ...
    NoCut_COIN_Pions = [tree["H_gtr_beta"], tree["H_gtr_xp"], tree["H_gtr_yp"], tree["H_gtr_dp"], tree["H_gtr_p"], tree["H_dc_x_fp"], tree["H_dc_y_fp"], tree["H_dc_xp_fp"], tree["H_dc_yp_fp"], tree["H_hod_goodscinhit"], tree["H_hod_goodstarttime"], tree["H_cal_etotnorm"], tree["H_cal_etottracknorm"], tree["H_cer_npeSum"], tree["CTime_ePiCoinTime_ROC1"], tree["P_gtr_beta"], tree["P_gtr_xp"], tree["P_gtr_yp"], tree["P_gtr_p"], tree["P_gtr_dp"], tree["P_dc_x_fp"], tree["P_dc_y_fp"], tree["P_dc_xp_fp"], tree["P_dc_yp_fp"], tree["P_hod_goodscinhit"], tree["P_hod_goodstarttime"], tree["P_cal_etotnorm"], tree["P_cal_etottracknorm"], tree["P_aero_npeSum"], tree["P_aero_xAtAero"], tree["P_aero_yAtAero"], tree["P_hgcer_npeSum"], tree["P_hgcer_xAtCer"], tree["P_hgcer_yAtCer"], tree["P_ngcer_npeSum"], tree["P_ngcer_xAtCer"], tree["P_ngcer_yAtCer"], tree["MMpi"], tree["H_RF_Dist"],tree["P_RF_Dist"], tree["Q2"], tree["W"], tree["epsilon"], tree["ph_q"], tree["MandelT"], tree["pmiss"], tree["pmiss_x"], tree["pmiss_y"], tree["pmiss_z"], tree["emiss"], tree["Erecoil"], tree["Mrecoil"]]

    Uncut_COIN_Pions = [(tree["H_gtr_beta"], tree["H_gtr_xp"], tree["H_gtr_yp"], tree["H_gtr_dp"], tree["H_gtr_p"], tree["H_dc_x_fp"], tree["H_dc_y_fp"], tree["H_dc_xp_fp"], tree["H_dc_yp_fp"], tree["H_hod_goodscinhit"], tree["H_hod_goodstarttime"], tree["H_cal_etotnorm"], tree["H_cal_etottracknorm"], tree["H_cer_npeSum"], tree["CTime_ePiCoinTime_ROC1"], tree["P_gtr_beta"], tree["P_gtr_xp"], tree["P_gtr_yp"], tree["P_gtr_p"], tree["P_gtr_dp"], tree["P_dc_x_fp"], tree["P_dc_y_fp"], tree["P_dc_xp_fp"], tree["P_dc_yp_fp"], tree["P_hod_goodscinhit"], tree["P_hod_goodstarttime"], tree["P_cal_etotnorm"], tree["P_cal_etottracknorm"], tree["P_aero_npeSum"], tree["P_aero_xAtAero"], tree["P_aero_yAtAero"], tree["P_hgcer_npeSum"], tree["P_hgcer_xAtCer"], tree["P_hgcer_yAtCer"], tree["P_ngcer_npeSum"], tree["P_ngcer_xAtCer"], tree["P_ngcer_yAtCer"], tree["MMpi"], tree["H_RF_Dist"],tree["P_RF_Dist"], tree["Q2"], tree["W"], tree["epsilon"], tree["ph_q"], tree["MandelT"], tree["pmiss"], tree["pmiss_x"], tree["pmiss_y"], tree["pmiss_z"], tree["emiss"], tree["Erecoil"], tree["Mrecoil"]) for (tree["H_gtr_beta"], tree["H_gtr_xp"], tree["H_gtr_yp"], tree["H_gtr_dp"], tree["H_gtr_p"], tree["H_dc_x_fp"], tree["H_dc_y_fp"], tree["H_dc_xp_fp"], tree["H_dc_yp_fp"], tree["H_hod_goodscinhit"], tree["H_hod_goodstarttime"], tree["H_cal_etotnorm"], tree["H_cal_etottracknorm"], tree["H_cer_npeSum"], tree["CTime_ePiCoinTime_ROC1"], tree["P_gtr_beta"], tree["P_gtr_xp"], tree["P_gtr_yp"], tree["P_gtr_p"], tree["P_gtr_dp"], tree["P_dc_x_fp"], tree["P_dc_y_fp"], tree["P_dc_xp_fp"], tree["P_dc_yp_fp"], tree["P_hod_goodscinhit"], tree["P_hod_goodstarttime"], tree["P_cal_etotnorm"], tree["P_cal_etottracknorm"], tree["P_aero_npeSum"], tree["P_aero_xAtAero"], tree["P_aero_yAtAero"], tree["P_hgcer_npeSum"], tree["P_hgcer_xAtCer"], tree["P_hgcer_yAtCer"], tree["P_ngcer_npeSum"], tree["P_ngcer_xAtCer"], tree["P_ngcer_yAtCer"], tree["MMpi"], tree["H_RF_Dist"], tree["P_RF_Dist"], tree["Q2"], tree["W"], tree["epsilon"], tree["ph_q"], tree["MandelT"], tree["pmiss"], tree["pmiss_x"], tree["pmiss_y"], tree["pmiss_z"], tree["emiss"], tree["Erecoil"], tree["Mrecoil"]) in zip(*NoCut_COIN_Pions)
        ]

    # Create array of arrays of pions after cuts, all events, prompt and random          

    Cut_COIN_Pions_tmp = NoCut_COIN_Pions
    Cut_COIN_Pions_accpt_tmp = []
    Cut_COIN_Pions_prompt_tmp = []
    Cut_COIN_Pions_rand_tmp = []

    for arr in Cut_COIN_Pions_tmp:
        Cut_COIN_Pions_accpt_tmp.append(c.add_cut(arr, "coin_epi_cut_all_noRF"))
        Cut_COIN_Pions_prompt_tmp.append(c.add_cut(arr, "coin_epi_cut_prompt_noRF"))
        Cut_COIN_Pions_rand_tmp.append(c.add_cut(arr, "coin_epi_cut_rand_noRF"))

    Cut_COIN_Pions_accpt = [(tree["H_gtr_beta"], tree["H_gtr_xp"], tree["H_gtr_yp"], tree["H_gtr_dp"], tree["H_gtr_p"], tree["H_dc_x_fp"], tree["H_dc_y_fp"], tree["H_dc_xp_fp"], tree["H_dc_yp_fp"], tree["H_hod_goodscinhit"], tree["H_hod_goodstarttime"], tree["H_cal_etotnorm"], tree["H_cal_etottracknorm"], tree["H_cer_npeSum"], tree["CTime_ePiCoinTime_ROC1"], tree["P_gtr_beta"], tree["P_gtr_xp"], tree["P_gtr_yp"], tree["P_gtr_p"], tree["P_gtr_dp"], tree["P_dc_x_fp"], tree["P_dc_y_fp"], tree["P_dc_xp_fp"], tree["P_dc_yp_fp"], tree["P_hod_goodscinhit"], tree["P_hod_goodstarttime"], tree["P_cal_etotnorm"], tree["P_cal_etottracknorm"], tree["P_aero_npeSum"], tree["P_aero_xAtAero"], tree["P_aero_yAtAero"], tree["P_hgcer_npeSum"], tree["P_hgcer_xAtCer"], tree["P_hgcer_yAtCer"], tree["P_ngcer_npeSum"], tree["P_ngcer_xAtCer"], tree["P_ngcer_yAtCer"], tree["MMpi"], tree["H_RF_Dist"], tree["P_RF_Dist"], tree["Q2"], tree["W"], tree["epsilon"], tree["ph_q"], tree["MandelT"], tree["pmiss"], tree["pmiss_x"], tree["pmiss_y"], tree["pmiss_z"], tree["emiss"], tree["Erecoil"], tree["Mrecoil"]) for (tree["H_gtr_beta"], tree["H_gtr_xp"], tree["H_gtr_yp"], tree["H_gtr_dp"], tree["H_gtr_p"], tree["H_dc_x_fp"], tree["H_dc_y_fp"], tree["H_dc_xp_fp"], tree["H_dc_yp_fp"], tree["H_hod_goodscinhit"], tree["H_hod_goodstarttime"], tree["H_cal_etotnorm"], tree["H_cal_etottracknorm"], tree["H_cer_npeSum"], tree["CTime_ePiCoinTime_ROC1"], tree["P_gtr_beta"], tree["P_gtr_xp"], tree["P_gtr_yp"], tree["P_gtr_p"], tree["P_gtr_dp"], tree["P_dc_x_fp"], tree["P_dc_y_fp"], tree["P_dc_xp_fp"], tree["P_dc_yp_fp"], tree["P_hod_goodscinhit"], tree["P_hod_goodstarttime"], tree["P_cal_etotnorm"], tree["P_cal_etottracknorm"], tree["P_aero_npeSum"], tree["P_aero_xAtAero"], tree["P_aero_yAtAero"], tree["P_hgcer_npeSum"], tree["P_hgcer_xAtCer"], tree["P_hgcer_yAtCer"], tree["P_ngcer_npeSum"], tree["P_ngcer_xAtCer"], tree["P_ngcer_yAtCer"], tree["MMpi"], tree["H_RF_Dist"], tree["P_RF_Dist"], tree["Q2"], tree["W"], tree["epsilon"], tree["ph_q"], tree["MandelT"], tree["pmiss"], tree["pmiss_x"], tree["pmiss_y"], tree["pmiss_z"], tree["emiss"], tree["Erecoil"], tree["Mrecoil"]) in zip(*Cut_COIN_Pions_accpt_tmp)
        ]

    Cut_COIN_Pions_prompt = [(tree["H_gtr_beta"], tree["H_gtr_xp"], tree["H_gtr_yp"], tree["H_gtr_dp"], tree["H_gtr_p"], tree["H_dc_x_fp"], tree["H_dc_y_fp"], tree["H_dc_xp_fp"], tree["H_dc_yp_fp"], tree["H_hod_goodscinhit"], tree["H_hod_goodstarttime"], tree["H_cal_etotnorm"], tree["H_cal_etottracknorm"], tree["H_cer_npeSum"], tree["CTime_ePiCoinTime_ROC1"], tree["P_gtr_beta"], tree["P_gtr_xp"], tree["P_gtr_yp"], tree["P_gtr_p"], tree["P_gtr_dp"], tree["P_dc_x_fp"], tree["P_dc_y_fp"], tree["P_dc_xp_fp"], tree["P_dc_yp_fp"], tree["P_hod_goodscinhit"], tree["P_hod_goodstarttime"], tree["P_cal_etotnorm"], tree["P_cal_etottracknorm"], tree["P_aero_npeSum"], tree["P_aero_xAtAero"], tree["P_aero_yAtAero"], tree["P_hgcer_npeSum"], tree["P_hgcer_xAtCer"], tree["P_hgcer_yAtCer"], tree["P_ngcer_npeSum"], tree["P_ngcer_xAtCer"], tree["P_ngcer_yAtCer"], tree["MMpi"], tree["H_RF_Dist"], tree["P_RF_Dist"], tree["Q2"], tree["W"], tree["epsilon"], tree["ph_q"], tree["MandelT"], tree["pmiss"], tree["pmiss_x"], tree["pmiss_y"], tree["pmiss_z"], tree["emiss"], tree["Erecoil"], tree["Mrecoil"]) for (tree["H_gtr_beta"], tree["H_gtr_xp"], tree["H_gtr_yp"], tree["H_gtr_dp"], tree["H_gtr_p"], tree["H_dc_x_fp"], tree["H_dc_y_fp"], tree["H_dc_xp_fp"], tree["H_dc_yp_fp"], tree["H_hod_goodscinhit"], tree["H_hod_goodstarttime"], tree["H_cal_etotnorm"], tree["H_cal_etottracknorm"], tree["H_cer_npeSum"], tree["CTime_ePiCoinTime_ROC1"],tree["P_gtr_beta"], tree["P_gtr_xp"], tree["P_gtr_yp"], tree["P_gtr_p"], tree["P_gtr_dp"], tree["P_dc_x_fp"], tree["P_dc_y_fp"], tree["P_dc_xp_fp"], tree["P_dc_yp_fp"], tree["P_hod_goodscinhit"], tree["P_hod_goodstarttime"], tree["P_cal_etotnorm"], tree["P_cal_etottracknorm"], tree["P_aero_npeSum"], tree["P_aero_xAtAero"], tree["P_aero_yAtAero"], tree["P_hgcer_npeSum"], tree["P_hgcer_xAtCer"], tree["P_hgcer_yAtCer"], tree["P_ngcer_npeSum"], tree["P_ngcer_xAtCer"], tree["P_ngcer_yAtCer"], tree["MMpi"], tree["H_RF_Dist"], tree["P_RF_Dist"], tree["Q2"], tree["W"], tree["epsilon"], tree["ph_q"], tree["MandelT"], tree["pmiss"], tree["pmiss_x"], tree["pmiss_y"], tree["pmiss_z"], tree["emiss"], tree["Erecoil"], tree["Mrecoil"]) in zip(*Cut_COIN_Pions_prompt_tmp)
        ]

    Cut_COIN_Pions_random = [(tree["H_gtr_beta"], tree["H_gtr_xp"], tree["H_gtr_yp"], tree["H_gtr_dp"], tree["H_gtr_p"], tree["H_dc_x_fp"], tree["H_dc_y_fp"], tree["H_dc_xp_fp"], tree["H_dc_yp_fp"], tree["H_hod_goodscinhit"], tree["H_hod_goodstarttime"], tree["H_cal_etotnorm"], tree["H_cal_etottracknorm"], tree["H_cer_npeSum"], tree["CTime_ePiCoinTime_ROC1"], tree["P_gtr_beta"], tree["P_gtr_xp"], tree["P_gtr_yp"], tree["P_gtr_p"], tree["P_gtr_dp"], tree["P_dc_x_fp"], tree["P_dc_y_fp"], tree["P_dc_xp_fp"], tree["P_dc_yp_fp"], tree["P_hod_goodscinhit"], tree["P_hod_goodstarttime"], tree["P_cal_etotnorm"], tree["P_cal_etottracknorm"], tree["P_aero_npeSum"], tree["P_aero_xAtAero"], tree["P_aero_yAtAero"], tree["P_hgcer_npeSum"], tree["P_hgcer_xAtCer"], tree["P_hgcer_yAtCer"], tree["P_ngcer_npeSum"], tree["P_ngcer_xAtCer"], tree["P_ngcer_yAtCer"], tree["MMpi"], tree["H_RF_Dist"], tree["P_RF_Dist"], tree["Q2"], tree["W"], tree["epsilon"], tree["ph_q"], tree["MandelT"], tree["pmiss"], tree["pmiss_x"], tree["pmiss_y"], tree["pmiss_z"], tree["emiss"], tree["Erecoil"], tree["Mrecoil"]) for (tree["H_gtr_beta"], tree["H_gtr_xp"], tree["H_gtr_yp"], tree["H_gtr_dp"], tree["H_gtr_p"], tree["H_dc_x_fp"], tree["H_dc_y_fp"], tree["H_dc_xp_fp"], tree["H_dc_yp_fp"], tree["H_hod_goodscinhit"], tree["H_hod_goodstarttime"], tree["H_cal_etotnorm"], tree["H_cal_etottracknorm"], tree["H_cer_npeSum"], tree["CTime_ePiCoinTime_ROC1"], tree["P_gtr_beta"], tree["P_gtr_xp"], tree["P_gtr_yp"], tree["P_gtr_p"], tree["P_gtr_dp"], tree["P_dc_x_fp"], tree["P_dc_y_fp"], tree["P_dc_xp_fp"], tree["P_dc_yp_fp"], tree["P_hod_goodscinhit"], tree["P_hod_goodstarttime"], tree["P_cal_etotnorm"], tree["P_cal_etottracknorm"], tree["P_aero_npeSum"], tree["P_aero_xAtAero"], tree["P_aero_yAtAero"], tree["P_hgcer_npeSum"], tree["P_hgcer_xAtCer"], tree["P_hgcer_yAtCer"], tree["P_ngcer_npeSum"], tree["P_ngcer_xAtCer"], tree["P_ngcer_yAtCer"], tree["MMpi"], tree["H_RF_Dist"], tree["P_RF_Dist"], tree["Q2"], tree["W"], tree["epsilon"], tree["ph_q"], tree["MandelT"], tree["pmiss"], tree["pmiss_x"], tree["pmiss_y"], tree["pmiss_z"], tree["emiss"], tree["Erecoil"], tree["Mrecoil"]) in zip(*Cut_COIN_Pions_rand_tmp)
        ]
...
#        dataframe_to_root(df, f"{OUTPATH}/{runNum}_{MaxEvent}_Analysed_Data.root", data_keys[i], mode)
        ...
        if (i == 0):
            pd.DataFrame(data.get(data_keys[i]), columns = DFHeader, index = None).to_root("%s/%s_%s_ProdCoin_Analysed_Data.root" % (OUTPATH, runNum, MaxEvent), key ="%s" % data_keys[i])
        elif (i != 0):
            pd.DataFrame(data.get(data_keys[i]), columns = DFHeader, index = None).to_root("%s/%s_%s_ProdCoin_Analysed_Data.root" % (OUTPATH, runNum, MaxEvent), key ="%s" % data_keys[i], mode ='a')
