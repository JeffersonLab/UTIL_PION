...
# Description:
# ================================================================
# Time-stamp: "2023-12-18 12:36:46 trottar"
# ================================================================
#
...
if len(sys.argv)-1!=4:
    print("!!!!! ERROR !!!!!\n Expected 4 arguments\n Usage is with - ROOTfilePrefix RunNumber MaxEvents RunType\n!!!!! ERROR !!!!!")
    sys.exit(1)
...
if "HeePCoin" in RunType:
    lt=Root(os.path.realpath(__file__),"HGCerHeeP",ROOTPrefix,runNum,MaxEvent,cut_f,cuts)
else:
