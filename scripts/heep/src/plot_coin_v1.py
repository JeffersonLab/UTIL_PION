...
# Description:
# ================================================================
# Time-stamp: "2022-06-30 01:29:19 trottar"
# ================================================================
#
...
P_gtr_beta_protons_uncut = ROOT.TH1D("P_gtr_beta_protons_uncut", "SHMS #beta; SHMS_gtr_#beta; Counts", 200, 0.5, 1.3)
...
P_gtr_p_protons_uncut = ROOT.TH1D("P_gtr_p_protons_uncut", "SHMS p; SHMS_gtr_p; Counts", 200, 1, 7)
...
P_ngcer_npeSum_protons_uncut = ROOT.TH1D("P_ngcer_npeSum_protons_uncut", "SHMS NGC npeSum; SHMS_ngcer_npeSum; Counts", 200, 0, 50)
P_ngcer_xAtCer_protons_uncut = ROOT.TH1D("P_ngcer_xAtCer_protons_uncut", "SHMS NGC xAtCer; SHMS_ngcer_xAtCer; Counts", 200, -60, 60)
...
P_kin_secondary_Erecoil_protons_uncut = ROOT.TH1D("P_kin_secondary_Erecoil_protons_uncut", "Erecoil Distribution; Erecoil; Counts", 200, -0.8, 0.8)
P_kin_secondary_emiss_nuc_protons_uncut = ROOT.TH1D("P_kin_secondary_emiss_nuc_protons_uncut", "Energy Distribution; emiss_nuc; Counts", 200, -0.8, 0.8)
P_kin_secondary_Mrecoil_protons_uncut = ROOT.TH1D("P_kin_secondary_Mrecoil_protons_uncut", "Mrecoil Distribution; Mrecoil; Counts", 200, -0.8, 0.8)
P_kin_secondary_W_protons_uncut = ROOT.TH1D("P_kin_secondary_W_protons_uncut", "W Distribution; W; Counts", 200, 0, 2)
...
P_ngcer_npeSum_protons_cut_all = ROOT.TH1D("P_ngcer_npeSum_protons_cut_all", "SHMS NGC npeSum; SHMS_ngcer_npeSum; Counts", 200, 0, 50)
...
P_kin_secondary_Erecoil_protons_cut_all = ROOT.TH1D("P_kin_secondary_Erecoil_protons_cut_all", "Erecoil Distribution; Erecoil; Counts", 200, -0.8, 0.8)
P_kin_secondary_emiss_nuc_protons_cut_all = ROOT.TH1D("P_kin_secondary_emiss_nuc_protons_cut_all", "Energy Distribution; emiss_nuc; Counts", 200, -0.8, 0.8)
P_kin_secondary_Mrecoil_protons_cut_all = ROOT.TH1D("P_kin_secondary_Mrecoil_protons_cut_all", "Mrecoil Distribution; Mrecoil; Counts", 200, -0.8, 0.8)
P_kin_secondary_W_protons_cut_all = ROOT.TH1D("P_kin_secondary_W_protons_cut_all", "W Distribution; W; Counts", 200, 0, 2)
...
P_hgcer_npeSum_vs_ngcer_npeSum_protons_uncut = ROOT.TH2D("P_hgcer_npeSum_vs_ngcer_npeSum_protons_uncut", "SHMS HGC npeSum vs SHMS NGC npeSum (no cut); SHMS_hgcer_npeSum; SHMS_ngcer_npeSum", 100, 0, 50, 100, 0, 50)
...
P_ngcer_yAtCer_vs_ngcer_xAtCer_protons_uncut = ROOT.TH2D("P_ngcer_yAtCer_vs_ngcer_xAtCer_protons_uncut", "SHMS NGC yAtCer vs SHMS NGC xAtCer (no cut); SHMS_ngcer_yAtCer; SHMS_ngcer_xAtCer", 100, -50, 50, 100, -50, 50)
...
P_hgcer_npeSum_vs_ngcer_npeSum_protons_cut_all = ROOT.TH2D("P_hgcer_npeSum_vs_ngcer_npeSum_protons_cut_all", "SHMS HGC npeSum vs SHMS NGC npeSum (with cuts); SHMS_hgcer_npeSum; SHMS_ngcer_npeSum", 100, 0, 50, 100, 0, 50)
...
P_ngcer_yAtCer_vs_ngcer_xAtCer_protons_cut_all = ROOT.TH2D("P_ngcer_yAtCer_vs_ngcer_xAtCer_protons_cut_all", "SHMS NGC yAtCer vs SHMS NGC xAtCer (with cuts); SHMS_ngcer_yAtCer; SHMS_ngcer_xAtCer", 100, -50, 50, 100, -50, 50)
...
for event in Uncut_Proton_Events_tree:
    ...
    P_kin_secondary_Erecoil_protons_uncut.Fill(event.Erecoil)
    P_kin_secondary_emiss_nuc_protons_uncut.Fill(event.emiss_nuc)
    P_kin_secondary_Mrecoil_protons_uncut.Fill(event.Mrecoil)
    P_kin_secondary_W_protons_uncut.Fill(event.W)
    ...
    P_hgcer_npeSum_vs_ngcer_npeSum_protons_uncut.Fill(event.P_hgcer_npeSum, event.P_ngcer_npeSum)
...
for event in Cut_Proton_Events_All_tree:
    ...
    P_kin_secondary_Erecoil_protons_cut_all.Fill(event.Erecoil)
    P_kin_secondary_emiss_nuc_protons_cut_all.Fill(event.emiss_nuc)
    P_kin_secondary_Mrecoil_protons_cut_all.Fill(event.Mrecoil)
    P_kin_secondary_W_protons_cut_all.Fill(event.W)
    ...
    P_hgcer_npeSum_vs_ngcer_npeSum_protons_cut_all.Fill(event.P_hgcer_npeSum, event.P_ngcer_npeSum)
...
P_kin_secondary_Erecoil_protons_uncut.Write()
P_kin_secondary_emiss_nuc_protons_uncut.Write()
P_kin_secondary_Mrecoil_protons_uncut.Write()
P_kin_secondary_W_protons_uncut.Write()
...
P_hgcer_npeSum_vs_ngcer_npeSum_protons_uncut.Write()
...
P_kin_secondary_Erecoil_protons_cut_all.Write()
P_kin_secondary_emiss_nuc_protons_cut_all.Write()
P_kin_secondary_Mrecoil_protons_cut_all.Write()
P_kin_secondary_W_protons_cut_all.Write()
...
P_hgcer_npeSum_vs_ngcer_npeSum_protons_cut_all.Write()
