...
H_dc_x_fp_protons_uncut = ROOT.TH1D("H_dc_x_fp_protons_uncut", "HMS x_fp'; HMS_dc_x_fp; Counts", 200, -0.2, 0.2)
H_dc_y_fp_protons_uncut = ROOT.TH1D("H_dc_y_fp_protons_uncut", "HMS y_fp'; HMS_dc_y_fp; Counts", 200, -0.2, 0.2)
H_dc_xp_fp_protons_uncut = ROOT.TH1D("H_dc_xp_fp_protons_uncut", "HMS xp_fp'; HMS_dc_xp_fp; Counts", 200, -0.2, 0.2)
H_dc_yp_fp_protons_uncut = ROOT.TH1D("H_dc_yp_fp_protons_uncut", "HMS yp_fp'; HMS_dc_yp_fp; Counts", 200, -0.2, 0.2)
...
P_dc_x_fp_protons_uncut = ROOT.TH1D("P_dc_x_fp_protons_uncut", "SHMS x_fp'; SHMS_dc_x_fp; Counts", 200, -0.2, 0.2)
P_dc_y_fp_protons_uncut = ROOT.TH1D("P_dc_y_fp_protons_uncut", "SHMS y_fp'; SHMS_dc_y_fp; Counts", 200, -0.2, 0.2)
P_dc_xp_fp_protons_uncut = ROOT.TH1D("P_dc_xp_fp_protons_uncut", "SHMS xp_fp'; SHMS_dc_xp_fp; Counts", 200, -0.2, 0.2)
P_dc_yp_fp_protons_uncut = ROOT.TH1D("P_dc_yp_fp_protons_uncut", "SHMS yp_fp'; SHMS_dc_yp_fp; Counts", 200, -0.2, 0.2)
...
H_dc_x_fp_protons_cut_all = ROOT.TH1D("H_dc_x_fp_protons_cut_all", "HMS x_fp'; HMS_dc_x_fp; Counts", 200, -0.2, 0.2)
H_dc_y_fp_protons_cut_all = ROOT.TH1D("H_dc_y_fp_protons_cut_all", "HMS y_fp'; HMS_dc_y_fp; Counts", 200, -0.2, 0.2)
H_dc_xp_fp_protons_cut_all = ROOT.TH1D("H_dc_xp_fp_protons_cut_all", "HMS xp_fp'; HMS_dc_xp_fp; Counts", 200, -0.2, 0.2)
H_dc_yp_fp_protons_cut_all = ROOT.TH1D("H_dc_yp_fp_protons_cut_all", "HMS yp_fp'; HMS_dc_yp_fp; Counts", 200, -0.2, 0.2)
...
P_gtr_p_protons_cut_all = ROOT.TH1D("P_gtr_p_protons_cut_all", "SHMS p; SHMS_gtr_p; Counts", 200, 1, 7)
P_dc_x_fp_protons_cut_all = ROOT.TH1D("P_dc_x_fp_protons_cut_all", "SHMS x_fp'; SHMS_dc_x_fp; Counts", 200, -0.2, 0.2)
P_dc_y_fp_protons_cut_all = ROOT.TH1D("P_dc_y_fp_protons_cut_all", "SHMS y_fp'; SHMS_dc_y_fp; Counts", 200, -0.2, 0.2)
P_dc_xp_fp_protons_cut_all = ROOT.TH1D("P_dc_xp_fp_protons_cut_all", "SHMS xp_fp'; SHMS_dc_xp_fp; Counts", 200, -0.2, 0.2)
P_dc_yp_fp_protons_cut_all = ROOT.TH1D("P_dc_yp_fp_protons_cut_all", "SHMS yp_fp'; SHMS_dc_yp_fp; Counts", 200, -0.2, 0.2)
...
# Cut (Acceptance + PID + Prompt Selection) Histograms
H_gtr_beta_protons_prompt_cut_all = ROOT.TH1D("H_gtr_beta_protons_prompt_cut_all", "HMS #beta; HMS_gtr_#beta; Counts", 200, 0.8, 1.2)
H_gtr_xp_protons_prompt_cut_all = ROOT.TH1D("H_gtr_xp_protons_prompt_cut_all", "HMS x'; HMS_gtr_xp; Counts", 200, -0.2, 0.2)
H_gtr_yp_protons_prompt_cut_all = ROOT.TH1D("H_gtr_yp_protons_prompt_cut_all", "HMS y'; HMS_gtr_yp; Counts", 200, -0.2, 0.2)
H_gtr_dp_protons_prompt_cut_all = ROOT.TH1D("H_gtr_dp_protons_prompt_cut_all", "HMS #delta; HMS_gtr_dp; Counts", 200, -15, 15)
H_gtr_p_protons_prompt_cut_all = ROOT.TH1D("H_gtr_p_protons_prompt_cut_all", "HMS p; HMS_gtr_p; Counts", 200, 4, 8)
H_dc_x_fp_protons_prompt_cut_all = ROOT.TH1D("H_dc_x_fp_protons_prompt_cut_all", "HMS x_fp'; HMS_dc_x_fp; Counts", 200, -0.2, 0.2)
H_dc_y_fp_protons_prompt_cut_all = ROOT.TH1D("H_dc_y_fp_protons_prompt_cut_all", "HMS y_fp'; HMS_dc_y_fp; Counts", 200, -0.2, 0.2)
H_dc_xp_fp_protons_prompt_cut_all = ROOT.TH1D("H_dc_xp_fp_protons_prompt_cut_all", "HMS xp_fp'; HMS_dc_xp_fp; Counts", 200, -0.2, 0.2)
H_dc_yp_fp_protons_prompt_cut_all = ROOT.TH1D("H_dc_yp_fp_protons_prompt_cut_all", "HMS yp_fp'; HMS_dc_yp_fp; Counts", 200, -0.2, 0.2)
H_hod_goodscinhit_protons_prompt_cut_all = ROOT.TH1D("H_hod_goodscinhit_protons_prompt_cut_all", "HMS hod goodscinhit; HMS_hod_goodscinhit; Counts", 200, 0.7, 1.3)
H_hod_goodstarttime_protons_prompt_cut_all = ROOT.TH1D("H_hod_goodstarttime_protons_prompt_cut_all", "HMS hod goodstarttime; HMS_hod_goodstarttime; Counts", 200, 0.7, 1.3)
H_cal_etotnorm_protons_prompt_cut_all = ROOT.TH1D("H_cal_etotnorm_protons_prompt_cut_all", "HMS cal etotnorm; HMS_cal_etotnorm; Counts", 200, 0.6, 1.4)
H_cal_etottracknorm_protons_prompt_cut_all = ROOT.TH1D("H_cal_etottracknorm_protons_prompt_cut_all", "HMS cal etottracknorm; HMS_cal_etottracknorm; Counts", 200, 0.6, 1.4)
H_cer_npeSum_protons_prompt_cut_all = ROOT.TH1D("H_cer_npeSum_protons_prompt_cut_all", "HMS cer npeSum; HMS_cer_npeSum; Counts", 200, 0, 50)
H_RFTime_Dist_protons_prompt_cut_all = ROOT.TH1D("H_RFTime_Dist_protons_prompt_cut_all", "HMS RFTime; HMS_RFTime; Counts", 200, 0, 4)
P_gtr_beta_protons_prompt_cut_all = ROOT.TH1D("P_gtr_beta_protons_prompt_cut_all", "SHMS #beta; SHMS_gtr_#beta; Counts", 200, 0.8, 1.2)
P_gtr_xp_protons_prompt_cut_all = ROOT.TH1D("P_gtr_xp_protons_prompt_cut_all", "SHMS x'; SHMS_gtr_xp; Counts", 200, -0.2, 0.2)
P_gtr_yp_protons_prompt_cut_all = ROOT.TH1D("P_gtr_yp_protons_prompt_cut_all", "SHMS y'; SHMS_gtr_yp; Counts", 200, -0.2, 0.2)
P_gtr_dp_protons_prompt_cut_all = ROOT.TH1D("P_gtr_dp_protons_prompt_cut_all", "SHMS #delta; SHMS_gtr_dp; Counts", 200, -15, 15)
P_gtr_p_protons_prompt_cut_all = ROOT.TH1D("P_gtr_p_protons_prompt_cut_all", "SHMS p; SHMS_gtr_p; Counts", 200, 1, 7)
P_dc_x_fp_protons_prompt_cut_all = ROOT.TH1D("P_dc_x_fp_protons_prompt_cut_all", "SHMS x_fp'; SHMS_dc_x_fp; Counts", 200, -0.2, 0.2)
P_dc_y_fp_protons_prompt_cut_all = ROOT.TH1D("P_dc_y_fp_protons_prompt_cut_all", "SHMS y_fp'; SHMS_dc_y_fp; Counts", 200, -0.2, 0.2)
P_dc_xp_fp_protons_prompt_cut_all = ROOT.TH1D("P_dc_xp_fp_protons_prompt_cut_all", "SHMS xp_fp'; SHMS_dc_xp_fp; Counts", 200, -0.2, 0.2)
P_dc_yp_fp_protons_prompt_cut_all = ROOT.TH1D("P_dc_yp_fp_protons_prompt_cut_all", "SHMS yp_fp'; SHMS_dc_yp_fp; Counts", 200, -0.2, 0.2)
P_hod_goodscinhit_protons_prompt_cut_all = ROOT.TH1D("P_hod_goodscinhit_protons_prompt_cut_all", "SHMS hod goodscinhit; SHMS_hod_goodscinhit; Counts", 200, 0.7, 1.3)
P_hod_goodstarttime_protons_prompt_cut_all = ROOT.TH1D("P_hod_goodstarttime_protons_prompt_cut_all", "SHMS hod goodstarttime; SHMS_hod_goodstarttime; Counts", 200, 0.7, 1.3)
P_cal_etotnorm_protons_prompt_cut_all = ROOT.TH1D("P_cal_etotnorm_protons_prompt_cut_all", "SHMS cal etotnorm; SHMS_cal_etotnorm; Counts", 200, 0, 1.2)
P_cal_etottracknorm_protons_prompt_cut_all = ROOT.TH1D("P_cal_etottracknorm_protons_prompt_cut_all", "SHMS cal etottracknorm; SHMS_cal_etottracknorm; Counts", 200, 0, 1.6)
P_hgcer_npeSum_protons_prompt_cut_all = ROOT.TH1D("P_hgcer_npeSum_protons_prompt_cut_all", "SHMS HGC npeSum; SHMS_hgcer_npeSum; Counts", 200, 0, 50)
P_hgcer_xAtCer_protons_prompt_cut_all = ROOT.TH1D("P_hgcer_xAtCer_protons_prompt_cut_all", "SHMS HGC xAtCer; SHMS_hgcer_xAtCer; Counts", 200, -40, 30)
P_hgcer_yAtCer_protons_prompt_cut_all = ROOT.TH1D("P_hgcer_yAtCer_protons_prompt_cut_all", "SHMS HGC yAtCer; SHMS_hgcer_yAtCer; Counts", 200, -30, 30)
P_ngcer_npeSum_protons_prompt_cut_all = ROOT.TH1D("P_ngcer_npeSum_protons_prompt_cut_all", "SHMS NGC npeSum; SHMS_ngcer_npeSum; Counts", 200, 0, 50)
P_ngcer_xAtCer_protons_prompt_cut_all = ROOT.TH1D("P_ngcer_xAtCer_protons_prompt_cut_all", "SHMS NGC xAtCer; SHMS_ngcer_xAtCer; Counts", 200, -40, 30)
P_ngcer_yAtCer_protons_prompt_cut_all = ROOT.TH1D("P_ngcer_yAtCer_protons_prompt_cut_all", "SHMS NGC yAtCer; SHMS_ngcer_yAtCer; Counts", 200, -30, 30)
P_aero_npeSum_protons_prompt_cut_all = ROOT.TH1D("P_aero_npeSum_protons_prompt_cut_all", "SHMS aero npeSum; SHMS_aero_npeSum; Counts", 200, 0, 50)
P_aero_xAtAero_protons_prompt_cut_all = ROOT.TH1D("P_acero_xAtAero_protons_prompt_cut_all", "SHMS aero xAtAero; SHMS_aero_xAtAero; Counts", 200, -40, 30)
P_aero_yAtAero_protons_prompt_cut_all = ROOT.TH1D("P_aero_yAtAero_protons_prompt_cut_all", "SHMS aero yAtAero; SHMS_aero_yAtAero; Counts", 200, -30, 30)
P_kin_MMp_protons_prompt_cut_all = ROOT.TH1D("P_kin_MMp_protons_prompt_cut_all", "Missing Mass cut; MM_{#pi}; Counts", 200, -1., 1.)
P_RFTime_Dist_protons_prompt_cut_all = ROOT.TH1D("P_RFTime_Dist_protons_prompt_cut_all", "SHMS RFTime; SHMS_RFTime; Counts", 200, 0, 4)
CTime_epCoinTime_ROC1_protons_prompt_cut_all = ROOT.TH1D("CTime_epCoinTime_ROC1_protons_prompt_cut_all", "Electron-Proton CTime; e p Coin_Time; Counts", 200, -50, 50)
P_kin_secondary_pmiss_protons_prompt_cut_all = ROOT.TH1D("P_kin_secondary_pmiss_protons_prompt_cut_all", "Momentum Distribution with cuts; pmiss; Counts", 200, -0.8, 0.8)
P_kin_secondary_pmiss_x_protons_prompt_cut_all = ROOT.TH1D("P_kin_secondary_pmiss_x_protons_prompt_cut_all", "Momentum_x Distribution with cuts; pmiss_x; Counts", 200, -0.6, 0.6)
P_kin_secondary_pmiss_y_protons_prompt_cut_all = ROOT.TH1D("P_kin_secondary_pmiss_y_protons_prompt_cut_all", "Momentum_y Distribution with cuts; pmiss_y; Counts", 200, -0.6, 0.6)
P_kin_secondary_pmiss_z_protons_prompt_cut_all = ROOT.TH1D("P_kin_secondary_pmiss_z_protons_prompt_cut_all", "Momentum_z Distribution with cuts; pmiss_z; Counts", 200, -0.6, 0.6)
P_kin_secondary_Erecoil_protons_prompt_cut_all = ROOT.TH1D("P_kin_secondary_Erecoil_protons_prompt_cut_all", "Erecoil Distribution; Erecoil; Counts", 200, -0.8, 0.8)
P_kin_secondary_emiss_nuc_protons_prompt_cut_all = ROOT.TH1D("P_kin_secondary_emiss_nuc_protons_prompt_cut_all", "Energy Distribution; emiss_nuc; Counts", 200, -0.8, 0.8)
P_kin_secondary_Mrecoil_protons_prompt_cut_all = ROOT.TH1D("P_kin_secondary_Mrecoil_protons_prompt_cut_all", "Mrecoil Distribution; Mrecoil; Counts", 200, -0.8, 0.8)
P_kin_secondary_W_protons_prompt_cut_all = ROOT.TH1D("P_kin_secondary_W_protons_prompt_cut_all", "W Distribution; W; Counts", 200, 0, 2)
...
# Cut (Acceptance + PID + Prompt Selection) Histograms
H_cal_etottracknorm_vs_H_cer_npeSum_protons_prompt_cut_all = ROOT.TH2D("H_cal_etottracknorm_vs_H_cer_npeSum_protons_prompt_cut_all","HMS cal etottracknorm vs HMS cer npeSum (with cuts); H_cal_etottracknorm; H_cer_npeSum",100, 0.5, 1.5, 100, 0, 40)
P_hgcer_npeSum_vs_aero_npeSum_protons_prompt_cut_all = ROOT.TH2D("P_hgcer_npeSum_vs_aero_npeSum_protons_prompt_cut_all", "SHMS HGC npeSum vs SHMS aero npeSum (with cuts); SHMS_hgcer_npeSum; SHMS_aero_npeSum", 100, 0, 50, 100, 0, 50)
P_ngcer_npeSum_vs_aero_npeSum_protons_prompt_cut_all = ROOT.TH2D("P_ngcer_npeSum_vs_aero_npeSum_protons_prompt_cut_all", "SHMS NGC npeSum vs SHMS aero npeSum (with cuts); SHMS_ngcer_npeSum; SHMS_aero_npeSum", 100, 0, 50, 100, 0, 50)
P_hgcer_npeSum_vs_ngcer_npeSum_protons_prompt_cut_all = ROOT.TH2D("P_hgcer_npeSum_vs_ngcer_npeSum_protons_prompt_cut_all", "SHMS HGC npeSum vs SHMS NGC npeSum (with cuts); SHMS_hgcer_npeSum; SHMS_ngcer_npeSum", 100, 0, 50, 100, 0, 50)
CTime_epCoinTime_ROC1_vs_P_kin_MMp_protons_prompt_cut_all = ROOT.TH2D("CTime_epCoinTime_ROC1_vs_P_kin_MMp_protons_prompt_cut_all","Electron-Proton CTime vs Missing Mass (with cuts); e p Coin_Time; MM_{p}", 100, -2, 2, 100, 0, 2)
P_hgcer_yAtCer_vs_hgcer_xAtCer_protons_prompt_cut_all = ROOT.TH2D("P_hgcer_yAtCer_vs_hgcer_xAtCer_protons_prompt_cut_all", "SHMS HGC yAtCer vs SHMS HGC xAtCer (with cuts); SHMS_hgcer_yAtCer; SHMS_hgcer_xAtCer", 100, -50, 50, 100, -50, 50)
P_ngcer_yAtCer_vs_ngcer_xAtCer_protons_prompt_cut_all = ROOT.TH2D("P_ngcer_yAtCer_vs_ngcer_xAtCer_protons_prompt_cut_all", "SHMS NGC yAtCer vs SHMS NGC xAtCer (with cuts); SHMS_ngcer_yAtCer; SHMS_ngcer_xAtCer", 100, -50, 50, 100, -50, 50)
P_aero_yAtAero_vs_aero_xAtAero_protons_prompt_cut_all = ROOT.TH2D("P_aero_yAtAero_vs_aero_xAtAero_protons_prompt_cut_all", "SHMS aero yAtAero vs SHMS aero xAtAero (with cuts); SHMS_aero_yAtAero; SHMS_aero_xAtAero", 100, -50, 50, 100, -50, 50)
CTime_epCoinTime_ROC1_vs_beta_protons_prompt_cut_all = ROOT.TH2D("CTime_epCoinTime_ROC1_vs_beta_protons_prompt_cut_all", "Electron-Proton CTime vs SHMS #beta (with cuts); e p Coin_Time; SHMS_#beta", 200, -2, 2, 200, 0, 2)
P_kin_MMp_vs_P_RFTime_protons_prompt_cut_all = ROOT.TH2D("P_kin_MMp_vs_P_RFTime_protons_prompt_cut_all", "Missing Mass vs SHMS RFTime (with cuts); MM_{p}; SHMS_RFTime_Dist", 200, 0, 2, 200, 0, 4)
P_aero_yAtAero_vs_beta_protons_prompt_cut_all = ROOT.TH2D("P_aero_yAtAero_vs_beta_protons_prompt_cut_all", "SHMS aero yAtAero vs SHMS #beta (with cut); SHMS_aero_yAtCer; SHMS_#beta", 100, -50, 50, 200, 0, 2)
P_aero_xAtAero_vs_beta_protons_prompt_cut_all = ROOT.TH2D("P_aero_xAtAero_vs_beta_protons_prompt_cut_all", "SHMS aero xAtAero vs SHMS #beta (with cut); SHMS_aero_xAtCer; SHMS_#beta", 100, -50, 50, 200, 0, 2)
P_aero_npeSum_vs_beta_protons_prompt_cut_all = ROOT.TH2D("P_aero_npeSum_vs_beta_protons_prompt_cut_all", "SHMS aero npeSum vs SHMS #beta (with cuts); SHMS_aero_npeSum; SHMS_#beta", 100, 0, 50, 200, 0, 2)
...
for event in Uncut_Proton_Events_tree:
    ...
    H_dc_x_fp_protons_uncut.Fill(event.H_dc_x_fp)
    H_dc_y_fp_protons_uncut.Fill(event.H_dc_y_fp)
    H_dc_xp_fp_protons_uncut.Fill(event.H_dc_xp_fp)
    H_dc_yp_fp_protons_uncut.Fill(event.H_dc_yp_fp)
    ...
    P_dc_x_fp_protons_uncut.Fill(event.P_dc_x_fp)
    P_dc_y_fp_protons_uncut.Fill(event.P_dc_y_fp)
    P_dc_xp_fp_protons_uncut.Fill(event.P_dc_xp_fp)
    P_dc_yp_fp_protons_uncut.Fill(event.P_dc_yp_fp)
...
for event in Cut_Proton_Events_All_tree:
    ...
    H_dc_x_fp_protons_cut_all.Fill(event.H_dc_x_fp)
    H_dc_y_fp_protons_cut_all.Fill(event.H_dc_y_fp)
    H_dc_xp_fp_protons_cut_all.Fill(event.H_dc_xp_fp)
    H_dc_yp_fp_protons_cut_all.Fill(event.H_dc_yp_fp)
    ...
    P_dc_x_fp_protons_cut_all.Fill(event.H_dc_x_fp)
    P_dc_y_fp_protons_cut_all.Fill(event.H_dc_y_fp)
    P_dc_xp_fp_protons_cut_all.Fill(event.H_dc_xp_fp)
    P_dc_yp_fp_protons_cut_all.Fill(event.H_dc_yp_fp)
...
for event in Cut_Proton_Events_Prompt_tree:
    H_gtr_beta_protons_prompt_cut_all.Fill(event.H_gtr_beta)
    H_gtr_xp_protons_prompt_cut_all.Fill(event.H_gtr_xp)
    H_gtr_yp_protons_prompt_cut_all.Fill(event.H_gtr_yp)
    H_gtr_dp_protons_prompt_cut_all.Fill(event.H_gtr_dp)
    H_gtr_p_protons_prompt_cut_all.Fill(event.H_gtr_p)
    H_dc_x_fp_protons_prompt_cut_all.Fill(event.H_dc_x_fp)
    H_dc_y_fp_protons_prompt_cut_all.Fill(event.H_dc_y_fp)
    H_dc_xp_fp_protons_prompt_cut_all.Fill(event.H_dc_xp_fp)
    H_dc_yp_fp_protons_prompt_cut_all.Fill(event.H_dc_yp_fp)
    H_hod_goodscinhit_protons_prompt_cut_all.Fill(event.H_hod_goodscinhit)
    H_hod_goodstarttime_protons_prompt_cut_all.Fill(event.H_hod_goodstarttime)
    H_cal_etotnorm_protons_prompt_cut_all.Fill(event.H_cal_etotnorm)
    H_cal_etottracknorm_protons_prompt_cut_all.Fill(event.H_cal_etottracknorm)
    H_cer_npeSum_protons_prompt_cut_all.Fill(event.H_cer_npeSum)
    H_RFTime_Dist_protons_prompt_cut_all.Fill(event.H_RF_Dist)
    P_gtr_beta_protons_prompt_cut_all.Fill(event.P_gtr_beta)
    P_gtr_xp_protons_prompt_cut_all.Fill(event.P_gtr_xp)
    P_gtr_yp_protons_prompt_cut_all.Fill(event.P_gtr_yp)
    P_gtr_dp_protons_prompt_cut_all.Fill(event.P_gtr_dp)
    P_gtr_p_protons_prompt_cut_all.Fill(event.P_gtr_p)
    P_dc_x_fp_protons_prompt_cut_all.Fill(event.H_dc_x_fp)
    P_dc_y_fp_protons_prompt_cut_all.Fill(event.H_dc_y_fp)
    P_dc_xp_fp_protons_prompt_cut_all.Fill(event.H_dc_xp_fp)
    P_dc_yp_fp_protons_prompt_cut_all.Fill(event.H_dc_yp_fp)
    P_hod_goodscinhit_protons_prompt_cut_all.Fill(event.P_hod_goodscinhit)
    P_hod_goodstarttime_protons_prompt_cut_all.Fill(event.P_hod_goodstarttime)
    P_cal_etotnorm_protons_prompt_cut_all.Fill(event.P_cal_etotnorm)
    P_cal_etottracknorm_protons_prompt_cut_all.Fill(event.P_cal_etottracknorm)
    P_hgcer_npeSum_protons_prompt_cut_all.Fill(event.P_hgcer_npeSum)
    P_hgcer_xAtCer_protons_prompt_cut_all.Fill(event.P_hgcer_xAtCer)
    P_hgcer_yAtCer_protons_prompt_cut_all.Fill(event.P_hgcer_yAtCer)
    P_ngcer_npeSum_protons_prompt_cut_all.Fill(event.P_ngcer_npeSum)
    P_ngcer_xAtCer_protons_prompt_cut_all.Fill(event.P_ngcer_xAtCer)
    P_ngcer_yAtCer_protons_prompt_cut_all.Fill(event.P_ngcer_yAtCer)
    P_aero_npeSum_protons_prompt_cut_all.Fill(event.P_aero_npeSum)
    P_aero_xAtAero_protons_prompt_cut_all.Fill(event.P_aero_xAtAero)
    P_aero_yAtAero_protons_prompt_cut_all.Fill(event.P_aero_yAtAero)
    P_kin_MMp_protons_prompt_cut_all.Fill(event.MMp)
    P_RFTime_Dist_protons_prompt_cut_all.Fill(event.P_RF_Dist)
    CTime_epCoinTime_ROC1_protons_prompt_cut_all.Fill(event.CTime_epCoinTime_ROC1)
    P_kin_secondary_pmiss_protons_prompt_cut_all.Fill(event.pmiss)
    P_kin_secondary_pmiss_x_protons_prompt_cut_all.Fill(event.pmiss_x)
    P_kin_secondary_pmiss_y_protons_prompt_cut_all.Fill(event.pmiss_y)
    P_kin_secondary_pmiss_z_protons_prompt_cut_all.Fill(event.pmiss_z)
    P_kin_secondary_Erecoil_protons_prompt_cut_all.Fill(event.Erecoil)
    P_kin_secondary_emiss_nuc_protons_prompt_cut_all.Fill(event.emiss_nuc)
    P_kin_secondary_Mrecoil_protons_prompt_cut_all.Fill(event.Mrecoil)
    P_kin_secondary_W_protons_prompt_cut_all.Fill(event.W)
    H_cal_etottracknorm_vs_H_cer_npeSum_protons_prompt_cut_all.Fill(event.H_cal_etottracknorm, event.H_cer_npeSum)
    P_hgcer_npeSum_vs_aero_npeSum_protons_prompt_cut_all.Fill(event.P_hgcer_npeSum, event.P_aero_npeSum)
    P_ngcer_npeSum_vs_aero_npeSum_protons_prompt_cut_all.Fill(event.P_ngcer_npeSum, event.P_aero_npeSum)
    P_hgcer_npeSum_vs_ngcer_npeSum_protons_prompt_cut_all.Fill(event.P_hgcer_npeSum, event.P_ngcer_npeSum)
    ...
    CTime_epCoinTime_ROC1_vs_beta_protons_prompt_cut_all.Fill(event.CTime_epCoinTime_ROC1, event.P_gtr_beta)
    CTime_epCoinTime_ROC1_vs_P_kin_MMp_protons_prompt_cut_all.Fill(event.CTime_epCoinTime_ROC1, event.MMp)
    P_kin_MMp_vs_P_RFTime_protons_prompt_cut_all.Fill(event.MMp, event.P_RF_Dist)
    P_aero_yAtAero_vs_beta_protons_prompt_cut_all.Fill(event.P_aero_yAtAero, event.P_gtr_beta)
    P_aero_xAtAero_vs_beta_protons_prompt_cut_all.Fill(event.P_aero_xAtAero, event.P_gtr_beta)
    P_aero_npeSum_vs_beta_protons_prompt_cut_all.Fill(event.P_aero_npeSum, event.P_gtr_beta)
...
H_gtr_beta_protons_prompt_cut_all.Write()
H_gtr_xp_protons_prompt_cut_all.Write()
H_gtr_yp_protons_prompt_cut_all.Write()
H_gtr_dp_protons_prompt_cut_all.Write()
H_gtr_p_protons_prompt_cut_all.Write()
H_hod_goodscinhit_protons_prompt_cut_all.Write()
H_hod_goodstarttime_protons_prompt_cut_all.Write()
H_cal_etotnorm_protons_prompt_cut_all.Write()
H_cal_etottracknorm_protons_prompt_cut_all.Write()
H_cer_npeSum_protons_prompt_cut_all.Write()
H_RFTime_Dist_protons_prompt_cut_all.Write()
P_gtr_beta_protons_prompt_cut_all.Write()
P_gtr_xp_protons_prompt_cut_all.Write()
P_gtr_yp_protons_prompt_cut_all.Write()
P_gtr_dp_protons_prompt_cut_all.Write()
P_gtr_p_protons_prompt_cut_all.Write()
P_hod_goodscinhit_protons_prompt_cut_all.Write()
P_hod_goodstarttime_protons_prompt_cut_all.Write()
P_cal_etotnorm_protons_prompt_cut_all.Write()
P_cal_etottracknorm_protons_prompt_cut_all.Write()
P_hgcer_npeSum_protons_prompt_cut_all.Write()
P_hgcer_xAtCer_protons_prompt_cut_all.Write()
P_hgcer_yAtCer_protons_prompt_cut_all.Write()
P_ngcer_npeSum_protons_prompt_cut_all.Write()
P_ngcer_xAtCer_protons_prompt_cut_all.Write()
P_ngcer_yAtCer_protons_prompt_cut_all.Write()
P_aero_npeSum_protons_prompt_cut_all.Write()
P_aero_xAtAero_protons_prompt_cut_all.Write()
P_aero_yAtAero_protons_prompt_cut_all.Write()
P_kin_MMp_protons_prompt_cut_all.Write()
P_RFTime_Dist_protons_prompt_cut_all.Write()
CTime_epCoinTime_ROC1_protons_prompt_cut_all.Write()
P_kin_secondary_pmiss_protons_prompt_cut_all.Write()
P_kin_secondary_pmiss_x_protons_prompt_cut_all.Write()
P_kin_secondary_pmiss_y_protons_prompt_cut_all.Write()
P_kin_secondary_pmiss_z_protons_prompt_cut_all.Write()
P_kin_secondary_Erecoil_protons_prompt_cut_all.Write()
P_kin_secondary_emiss_nuc_protons_prompt_cut_all.Write()
P_kin_secondary_Mrecoil_protons_prompt_cut_all.Write()
P_kin_secondary_W_protons_prompt_cut_all.Write()
H_cal_etottracknorm_vs_H_cer_npeSum_protons_prompt_cut_all.Write()
P_hgcer_npeSum_vs_aero_npeSum_protons_prompt_cut_all.Write()
P_ngcer_npeSum_vs_aero_npeSum_protons_prompt_cut_all.Write()
P_hgcer_npeSum_vs_ngcer_npeSum_protons_prompt_cut_all.Write()
CTime_epCoinTime_ROC1_vs_P_kin_MMp_protons_prompt_cut_all.Write()
...
CTime_epCoinTime_ROC1_vs_beta_protons_prompt_cut_all.Write()
P_kin_MMp_vs_P_RFTime_protons_prompt_cut_all.Write()
P_aero_yAtAero_vs_beta_protons_prompt_cut_all.Write()
P_aero_xAtAero_vs_beta_protons_prompt_cut_all.Write()
P_aero_npeSum_vs_beta_protons_prompt_cut_all.Write()
MMsquared.Write()
