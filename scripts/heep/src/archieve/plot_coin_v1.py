...
P_kin_secondary_W_protons_uncut = ROOT.TH1D("P_kin_secondary_W_protons_uncut", "W Distribution; W; Counts", 200, -0.8, 0.8)
...
P_kin_secondary_W_protons_cut_all = ROOT.TH1D("P_kin_secondary_W_protons_uncut", "W Distribution; W; Counts", 200, -0.8, 0.8)
...
for event in Uncut_Proton_Events_tree:
    ...
    P_kin_secondary_Erecoil_x_protons_uncut.Fill(event.Erecoil)
...
for event in Cut_Proton_Events_All_tree:
    ...
    P_kin_secondary_Erecoil_x_protons_cut_all.Fill(event.Erecoil)
