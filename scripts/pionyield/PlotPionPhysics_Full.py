...
if (FilenameOverride == False):
    Pion_Analysis_Distributions = "%s/%s_%s_Full_Pion_Analysis_Distributions_noRF_PID.pdf" % (OUTPATH, runNum, MaxEvent)
    Kaon_Analysis_Distributions = "%s/%s_%s_Full_Kaon_Analysis_Distributions_noRF_PID.pdf" % (OUTPATH, runNum, MaxEvent)
    Proton_Analysis_Distributions = "%s/%s_%s_Full_Proton_Analysis_Distributions_noRF_PID.pdf" % (OUTPATH, runNum, MaxEvent)
elif (FilenameOverride != False): # If filename override set, format the file name based upon the override file name
    Pion_Analysis_Distributions = "%s/%s_Full_Pion_Analysis_Distributions_noRF_PID.pdf" %(OUTPATH, (FilenameOverride.split("_Analysed_Data.root",1)[0]))
    Kaon_Analysis_Distributions = "%s/%s_Full_Kaon_Analysis_Distributions_noRF_PID.pdf" %(OUTPATH, (FilenameOverride.split("_Analysed_Data.root",1)[0]))
    Proton_Analysis_Distributions = "%s/%s_Full_Proton_Analysis_Distributions_noRF_PID.pdf" %(OUTPATH, (FilenameOverride.split("_Analysed_Data.root",1)[0]))
...
P_hgcer_npe_pions_cut = ROOT.TH1D("P_hgcer_npe_pions_cut", "SHMS HGC npeSum (noRF_PID_cut); SHMS_hgcer_npeSum; Counts", 200, 0, 50)
P_xhgcer_pions_cut = ROOT.TH1D("P_xhgcer_pions_cut", "SHMS HGC xAtCer (noRF_PID_cut); SHMS_hgcer_xAtCer; Counts", 200, -40, 30)
P_yhgcer_pions_cut = ROOT.TH1D("P_yhgcer_pions_cut", "SHMS HGC yAtCer (noRF_PID_cut); SHMS_hgcer_yAtCer; Counts", 200, -30, 30)
P_aero_npe_pions_cut = ROOT.TH1D("P_aero_npe_pions_cut", "SHMS aero npeSum (noRF_PID_cut); SHMS_aero_npeSum; Counts", 200, 0, 50)
...
P_ngcer_npe_pions_cut = ROOT.TH1D("P_ngcer_npe_pions_cut", "SHMS NGC npeSum (noRF_PID_cut); SHMS_ngcer_npeSum; Counts", 200, 0, 50)
...
P_MMpi_pions_cut = ROOT.TH1D("P_MMpi_pions_cut", "Missing Mass (noRF_PID_cut); MM_{#pi}; Counts", 200, 0.5, 1.8)
P_RFTime_pions_cut = ROOT.TH1D("P_RFTime_pions_cut", "SHMS RFTime (noRF_PID_cut); SHMS_RFTime; Counts", 200, 0, 4)
ePiCoinTime_pions_cut = ROOT.TH1D("ePiCoinTime_pions_cut", "Electron-Pion CTime (noRF_PID_cut); e #pi Coin_Time; Counts", 200, -50, 50)
...
P_MMpi_pions_cut_randm_sub = ROOT.TH1D("P_MMpi_pions_cut_randm_sub", "Missing Mass Rndm Sub (noRF_PID_cut); MM_{#pi}; Counts", 200, 0.5, 1.8)
...
P_hgcer_npe_kaons_cut = ROOT.TH1D("P_hgcer_npe_kaons_cut", "SHMS HGC npeSum (noRF_PID_cut); SHMS_hgcer_npeSum; Counts", 200, 0, 50)
...
P_aero_npe_kaons_cut = ROOT.TH1D("P_aero_npe_kaons_cut", "SHMS aero npeSum (noRF_PID_cut); SHMS_aero_npeSum; Counts", 200, 0, 50)
...
P_ngcer_npe_kaons_cut = ROOT.TH1D("P_ngcer_npe_kaons_cut", "SHMS NGC npeSum (noRF_PID_cut); SHMS_ngcer_npeSum; Counts", 200, 0, 50)
...
P_MMK_kaons_cut = ROOT.TH1D("P_MMK_kaons_cut", "Missing Mass (noRF_PID_cut); MM_{K}; Counts", 200, 0.5, 1.8)
P_RFTime_kaons_cut = ROOT.TH1D("P_RFTime_kaons_cut", "SHMS RFTime (noRF_PID_cut); SHMS_RFTime; Counts", 200, 0, 4)
eKCoinTime_kaons_cut = ROOT.TH1D("eKCoinTime_kaons_cut", "Electron-Kaon CTime (noRF_PID_cut); e K Coin_Time; Counts", 200, -50, 50)
...
P_MMK_kaons_cut_randm_sub = ROOT.TH1D("P_MMK_kaons_cut_randm_sub", "Missing Mass Rndm Sub (noRF_PID_cut); MM_{K}; Counts", 200, 0.5, 1.8)
...
P_hgcer_npe_protons_cut = ROOT.TH1D("P_hgcer_npe_protons_cut", "SHMS HGC npeSum (noRF_PID_cut); SHMS_hgcer_npeSum; Counts", 200, 0, 50)
...
P_aero_npe_protons_cut = ROOT.TH1D("P_aero_npe_protons_cut", "SHMS aero npeSum (noRF_PID_cut); SHMS_aero_npeSum; Counts", 200, 0, 50)
...
P_ngcer_npe_protons_cut = ROOT.TH1D("P_ngcer_npe_protons_cut", "SHMS NGC npeSum (noRF_PID_cut); SHMS_ngcer_npeSum; Counts", 200, 0, 50)
...
P_MMp_protons_cut = ROOT.TH1D("P_MMp_protons_cut", "Missing Mass (noRF_PID_cut); MM_{p}; Counts", 200, 0.5, 1.8)
P_RFTime_protons_cut = ROOT.TH1D("P_RFTime_protons_cut", "SHMS RFTime (noRF_PID_cut); SHMS_RFTime; Counts", 200, 0, 4)
epCoinTime_protons_cut = ROOT.TH1D("epCoinTime_protons_cut", "Electron-Proton CTime (noRF_PID_cut); e p Coin_Time; Counts", 200, -50, 50)
...
P_MMp_protons_cut_randm_sub = ROOT.TH1D("P_MMp_protons_cut_randm_sub", "Missing Mass Rndm Sub (noRF_PID_cut); MM_{p}; Counts", 200, 0.5, 1.8)
...
P_hgcer_vs_aero_npe_pions_cut = ROOT.TH2D("P_hgcer_vs_aero_npe_pions_cut", "SHMS HGC npeSum vs SHMS aero npeSum (noRF_PID_cut); SHMS_hgcer_npeSum; SHMS_aero_npeSum", 100, 0, 50, 100, 0, 50)
ePiCoinTime_vs_MMpi_pions_cut = ROOT.TH2D("ePiCoinTime_vs_MMpi_pions_cut","Electron-Pion CTime vs Missing Mass (noRF_PID_cut); e #pi Coin_Time; MM_{#pi}", 100, -2, 2, 100, 0, 2)
...
ePiCoinTime_vs_beta_pions_cut = ROOT.TH2D("ePiCoinTime_vs_beta_pions_cut", "Electron-Pion CTime vs SHMS #beta (noRF_PID_cut); e #pi Coin_Time; SHMS_#beta", 100, -2, 2, 100, 0.6, 1.4)
P_RFTime_vs_MMpi_pions_cut = ROOT.TH2D("P_RFTime_vs_MMpi_pions_cut", "SHMS RFTime vs Missing Mass (noRF_PID_cut); SHMS_RFTime_Dist; MM_{#pi}", 100, 0, 4, 100, 0, 2)
...
P_ngcer_vs_hgcer_npe_pions_cut = ROOT.TH2D("P_ngcer_vs_hgcer_npe_pions_cut", "SHMS NGC npeSum vs SHMS HGC npeSum (noRF_PID_cut); SHMS_ngcer_npeSum; SHMS_hgcer_npeSum", 100, 0, 50, 100, 0, 50)
P_ngcer_vs_aero_npe_pions_cut = ROOT.TH2D("P_ngcer_vs_aero_npe_pions_cut", "SHMS NGC npeSum vs SHMS aero npeSum (noRF_PID_cut); SHMS_ngcer_npeSum; SHMS_aero_npeSum", 100, 0, 50, 100, 0, 50)
...
P_MMpi_vs_beta_pions_cut = ROOT.TH2D("P_MMpi_vs_beta_pions_cut", "Missing Mass vs SHMS #beta (noRF_PID_cut); MM_{#pi}; SHMS_#beta", 100, 0, 2, 200, 0, 2)
...
P_hgcer_vs_aero_npe_kaons_cut = ROOT.TH2D("P_hgcer_vs_aero_npe_kaons_cut", "SHMS HGC npeSum vs SHMS aero npeSum (noRF_PID_cut); SHMS_hgcer_npeSum; SHMS_aero_npeSum", 100, 0, 0.5, 100, 0, 50)
eKCoinTime_vs_MMK_kaons_cut = ROOT.TH2D("eKCoinTime_vs_MMK_kaons_cut","Electron-Kaon CTime vs Missing Mass (noRF_PID_cut); e K Coin_Time; MM_{K}", 100, -2, 2, 100, 0, 2)
...
eKCoinTime_vs_beta_kaons_cut = ROOT.TH2D("eKCoinTime_vs_beta_kaons_cut", "Electron-Kaon CTime vs SHMS #beta (noRF_PID_cut); e K Coin_Time; SHMS_#beta", 100, -2, 2, 100, 0.6, 1.4)
P_RFTime_vs_MMK_kaons_cut = ROOT.TH2D("P_RFTime_vs_MMK_kaons_cut", "SHMS RFTime vs Missing Mass (noRF_PID_cut); SHMS_RFTime_Dist; MM_{K}", 100, 0, 4, 100, 0, 2)
...
P_ngcer_vs_hgcer_npe_kaons_cut = ROOT.TH2D("P_ngcer_vs_hgcer_npe_kaons_cut", "SHMS NGC npeSum vs SHMS HGC npeSum (noRF_PID_cut); SHMS_ngcer_npeSum; SHMS_hgcer_npeSum", 100, 0, 50, 100, 0, 0.5)
P_ngcer_vs_aero_npe_kaons_cut = ROOT.TH2D("P_ngcer_vs_aero_npe_kaons_cut", "SHMS NGC npeSum vs SHMS aero npeSum (noRF_PID_cut); SHMS_ngcer_npeSum; SHMS_aero_npeSum", 100, 0, 50, 100, 0, 50)
...
P_MMK_vs_beta_kaons_cut = ROOT.TH2D("P_MMK_vs_beta_kaons_cut", "Missing Mass vs SHMS #beta (noRF_PID_cut); MM_{K}; SHMS_#beta", 100, 0, 2, 200, 0, 2)
...
P_hgcer_vs_aero_npe_protons_cut = ROOT.TH2D("P_hgcer_vs_aero_npe_protons_cut", "SHMS HGC npeSum vs SHMS aero npeSum (noRF_PID_cut); SHMS_hgcer_npeSum; SHMS_aero_npeSum", 100, 0, 0.5, 100, 0, 0.5)
epCoinTime_vs_MMp_protons_cut = ROOT.TH2D("epCoinTime_vs_MMp_protons_cut","Electron-Proton CTime vs Missing Mass (noRF_PID_cut); e p Coin_Time; MM_{p}", 100, -2, 2, 100, 0, 2)
...
epCoinTime_vs_beta_protons_cut = ROOT.TH2D("epCoinTime_vs_beta_protons_cut", "Electron-Proton CTime vs SHMS #beta (noRF_PID_cut); e p Coin_Time; SHMS_#beta", 100, -2, 2, 100, 0.6, 1.4)
P_RFTime_vs_MMp_protons_cut = ROOT.TH2D("P_RFTime_vs_MMp_protons_cut", "SHMS RFTime vs Missing Mass (noRF_PID_cut); SHMS_RFTime_Dist; MM_{p}", 100, 0, 4, 100, 0, 2)
...
P_ngcer_vs_hgcer_npe_protons_cut = ROOT.TH2D("P_ngcer_vs_hgcer_npe_protons_cut", "SHMS NGC npeSum vs SHMS HGC npeSum (noRF_PID_cut); SHMS_ngcer_npeSum; SHMS_hgcer_npeSum", 100, 0, 50, 100, 0, 0.5)
P_ngcer_vs_aero_npe_protons_cut = ROOT.TH2D("P_ngcer_vs_aero_npe_protons_cut", "SHMS NGC npeSum vs SHMS aero npeSum (noRF_PID_cut); SHMS_ngcer_npeSum; SHMS_aero_npeSum", 100, 0, 50, 100, 0, 0.5)
...
P_MMp_vs_beta_protons_cut = ROOT.TH2D("P_MMp_vs_beta_protons_cut", "Missing Mass vs SHMS #beta (noRF_PID_cut); MM_{p}; SHMS_#beta", 100, 0, 2, 200, 0, 2)
...
P_HGC_xy_npe_pions_cut = ROOT.TH3D("P_HGC_xy_npe_pions_cut", "SHMS HGC NPE as fn of yAtCer vs SHMS HGC xAtCer (noRF_PID_cut); HGC_yAtCer(cm); HGC_xAtCer(cm); NPE", 100, -50, 50, 100, -50, 50, 100, 0.1 , 50)
P_Aero_xy_npe_pions_cut = ROOT.TH3D("P_Aero_xy_npe_pions_cut", "SHMS Aerogel NPE as fn of yAtCer vs xAtCer (noRF_PID_cut); Aero_yAtCer(cm); Aero_xAtCer(cm); NPE", 100, -50, 50, 100, -50, 50, 100, 0.1 , 50)
P_NGC_xy_npe_pions_cut = ROOT.TH3D("P_NGC_xy_npe_pions_cut", "SHMS NGC NPE as fn of yAtCer vs xAtCer (noRF_PID_cut); NGC_yAtCer(cm); NGC_xAtCer(cm); NPE", 100, -50, 50, 100, -50, 50, 100, 0.1 , 50)
...
P_HGC_xy_npe_kaons_cut = ROOT.TH3D("P_HGC_xy_npe_kaons_cut", "SHMS HGC NPE as fn of yAtCer vs SHMS HGC xAtCer (noRF_PID_cut); HGC_yAtCer(cm); HGC_xAtCer(cm); NPE", 100, -50, 50, 100, -50, 50, 100, 0.1 , 50)
P_Aero_xy_npe_kaons_cut = ROOT.TH3D("P_Aero_xy_npe_kaons_cut", "SHMS Aerogel NPE as fn of yAtCer vs xAtCer (noRF_PID_cut); Aero_yAtCer(cm); Aero_xAtCer(cm); NPE", 100, -50, 50, 100, -50, 50, 100, 0.1 , 50)
P_NGC_xy_npe_kaons_cut = ROOT.TH3D("P_NGC_xy_npe_kaons_cut", "SHMS NGC NPE as fn of yAtCer vs xAtCer (noRF_PID_cut); NGC_yAtCer(cm); NGC_xAtCer(cm); NPE", 100, -50, 50, 100, -50, 50, 100, 0.1 , 50)
...
P_HGC_xy_npe_protons_cut = ROOT.TH3D("P_HGC_xy_npe_protons_cut", "SHMS HGC NPE as fn of yAtCer vs SHMS HGC xAtCer (noRF_PID_cut); HGC_yAtCer(cm); HGC_xAtCer(cm); NPE", 100, -50, 50, 100, -50, 50, 100, 0.1 , 50)
P_Aero_xy_npe_protons_cut = ROOT.TH3D("P_Aero_xy_npe_protons_cut", "SHMS Aerogel NPE as fn of yAtCer vs xAtCer (noRF_PID_cut); Aero_yAtCer(cm); Aero_xAtCer(cm); NPE", 100, -50, 50, 100, -50, 50, 100, 0.1 , 50)
P_NGC_xy_npe_protons_cut = ROOT.TH3D("P_NGC_xy_npe_protons_cut", "SHMS NGC NPE as fn of yAtCer vs xAtCer (noRF_PID_cut); NGC_yAtCer(cm); NGC_xAtCer(cm); NPE", 100, -50, 50, 100, -50, 50, 100, 0.1 , 50)
...
legend6_pions.AddEntry("P_hgcer_npe_pions_cut", "with cuts (noRF_PID_Accpt)", "l")
...
legend7_pions.AddEntry("P_aero_npe_pions_cut", "with cuts (noRF_PID_Accpt)", "l")
...
legend4_pions.AddEntry("P_RFTime_pions_cut", "with cuts (noRF_PID_Accpt)", "l")
...
legend9_pions.AddEntry("ePiCoinTime_pions_cut_prompt", "CT_prompt with cuts (acpt/noRF/PID)", "l")
legend9_pions.AddEntry("ePiCoinTime_pions_cut_randm", "CT_randoms with cuts (acpt/noRF/PID)", "l")
...
legend10_pions.AddEntry("ePiCoinTime_pions_cut", "CT_with cuts (acpt/noRF/PID)", "l")
legend10_pions.AddEntry("ePiCoinTime_pions_cut_prompt", "CT_prompt with cuts (acpt/noRF/PID)", "l")
legend10_pions.AddEntry("ePiCoinTime_pions_cut_randm", "CT_randoms with cuts (acpt/noRF/PID)", "l")
...
legend11_pions.AddEntry("P_MMpi_pions_cut", "MM with cuts (acpt/noRF/PID)", "l")
legend11_pions.AddEntry("P_MMpi_pions_cut_prompt", "MM_prompt with cuts (acpt/noRF/PID)", "l")
legend11_pions.AddEntry("P_MMpi_pions_cut_randm", "MM_randoms with cuts (acpt/noRF/PID)", "l")
...
legend17_kaons.AddEntry("P_hgcer_npe_kaons_cut", "with cuts (acpt/noRF/PID)", "l")
...
legend18_kaons.AddEntry("P_aero_npe_kaons_cut", "with cuts (acpt/noRF/PID)", "l")
...
legend15_kaons.AddEntry("P_RFTime_kaons_cut", "with cuts (acpt/noRF/PID)", "l")
...
#legend16_kaons.AddEntry("P_RFTime_kaons_cut_RF", "noRF_cuts (acpt/PID)", "l")
#legend16_kaons.AddEntry("P_RFTime_kaons_cut", "noRF_cuts (acpt/PID)", "l")
...
legend20_kaons.AddEntry("eKCoinTime_kaons_cut_prompt", "CT_prompt with cuts (acpt/noRF/PID)", "l")
legend20_kaons.AddEntry("eKCoinTime_kaons_cut_randm", "CT_randoms with cuts (acpt/noRF/PID)", "l")
...
legend21_kaons.AddEntry("eKCoinTime_kaons_cut", "CT_with cuts (acpt/noRF/PID)", "l")
legend21_kaons.AddEntry("eKCoinTime_kaons_cut_prompt", "CT_prompt with cuts (acpt/noRF/PID)", "l")
legend21_kaons.AddEntry("eKCoinTime_kaons_cut_randm", "CT_randoms with cuts (acpt/noRF/PID)", "l")
...
legend22_kaons.AddEntry("P_MMK_kaons_cut", "MM with cuts (acpt/noRF/PID)", "l")
legend22_kaons.AddEntry("P_MMK_kaons_cut_prompt", "MM_prompt with cuts (acpt/noRF/PID)", "l")
legend22_kaons.AddEntry("P_MMK_kaons_cut_randm", "MM_randoms with cuts (acpt/noRF/PID)", "l")
...
legend28_protons.AddEntry("P_hgcer_npe_protons_cut", "with cuts (acpt/noRF/PID)", "l")
...
legend29_protons.AddEntry("P_aero_npe_protons_cut", "with cuts (acpt/noRF/PID)", "l")
...
legend26_protons.AddEntry("P_RFTime_protons_cut", "with cuts (acpt/noRF/PID)", "l")
...
#legend27_protons.AddEntry("P_RFTime_protons_cut_RF", "noRF_cuts (acpt/PID)", "l")
#legend27_protons.AddEntry("P_RFTime_protons_cut", "noRF_cuts (acpt/PID)", "l")
...
legend31_protons.AddEntry("epCoinTime_protons_cut_prompt", "CT_prompt with cuts (acpt/noRF/PID)", "l")
legend31_protons.AddEntry("epCoinTime_protons_cut_randm", "CT_randoms with cuts (acpt/noRF/PID)", "l")
...
legend32_protons.AddEntry("epCoinTime_protons_cut", "CT_with cuts (acpt/noRF/PID)", "l")
legend32_protons.AddEntry("epCoinTime_protons_cut_prompt", "CT_prompt with cuts (acpt/noRF/PID)", "l")
legend32_protons.AddEntry("epCoinTime_protons_cut_randm", "CT_randoms with cuts (acpt/noRF/PID)", "l")
...
legend33_protons.AddEntry("P_MMp_protons_cut", "MM with cuts (acpt/noRF/PID)", "l")
legend33_protons.AddEntry("P_MMp_protons_cut_prompt", "MM_prompt with cuts (acpt/noRF/PID)", "l")
legend33_protons.AddEntry("P_MMp_protons_cut_randm", "MM_randoms with cuts (acpt/noRF/PID)", "l")
