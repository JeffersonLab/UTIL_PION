...
H_gtr_beta_pions_uncut = ROOT.TH1D("H_gtr_beta_pions_uncut", "HMS #beta; HMS_gtr_#beta; Counts", 200, 0.8, 1.2)
...
H_gtr_dp_pions_uncut = ROOT.TH1D("H_gtr_dp_pions_uncut", "HMS #delta; HMS_gtr_dp; Counts", 200, -15, 15)
...
P_gtr_beta_pions_uncut = ROOT.TH1D("P_gtr_beta_pions_uncut", "SHMS #beta; SHMS_gtr_#beta; Counts", 200, 0.7, 1.3)
...
CTime_ePiCoinTime_ROC1_pions_uncut = ROOT.TH1D("CTime_ePiCoinTime_ROC1_pions_uncut", "Electron-Pion CTime; e #pi Coin_Time; Counts", 200, -60, 60)
...
H_gtr_beta_pions_cut_all = ROOT.TH1D("H_gtr_beta_pions_cut_all", "HMS #beta; HMS_gtr_#beta; Counts", 200, 0.8, 1.2)
...
H_gtr_dp_pions_cut_all = ROOT.TH1D("H_gtr_dp_pions_cut_all", "HMS #delta; HMS_gtr_dp; Counts", 200, -15, 15)
...
P_gtr_beta_pions_cut_all = ROOT.TH1D("P_gtr_beta_pions_cut_all", "SHMS #beta; SHMS_gtr_#beta; Counts", 200, 0.8, 1.2)
...
H_gtr_beta_kaons_uncut = ROOT.TH1D("H_gtr_beta_kaons_uncut", "HMS #beta; HMS_gtr_#beta; Counts", 200, 0.8, 1.2)
...
H_gtr_dp_kaons_uncut = ROOT.TH1D("H_gtr_dp_kaons_uncut", "HMS #delta; HMS_gtr_dp; Counts", 200, -15, 15)
...
P_gtr_beta_kaons_uncut = ROOT.TH1D("P_gtr_beta_kaons_uncut", "SHMS #beta; SHMS_gtr_#beta; Counts", 200, 0.7, 1.3)
...
CTime_eKCoinTime_ROC1_kaons_uncut = ROOT.TH1D("CTime_eKCoinTime_ROC1_kaons_uncut", "Electron-Kaon CTime; e K Coin_Time; Counts", 200, -60, 60)
...
H_gtr_beta_kaons_cut_all = ROOT.TH1D("H_gtr_beta_kaons_cut_all", "HMS #beta; HMS_gtr_#beta; Counts", 200, 0.8, 1.2)
...
H_gtr_dp_kaons_cut_all = ROOT.TH1D("H_gtr_dp_kaons_cut_all", "HMS #delta; HMS_gtr_dp; Counts", 200, -15, 15)
...
P_gtr_beta_kaons_cut_all = ROOT.TH1D("P_gtr_beta_kaons_cut_all", "SHMS #beta; SHMS_gtr_#beta; Counts", 200, 0.8, 1.2)
...
P_kin_MMpi_vs_P_RFTime_pions_uncut = ROOT.TH2D("P_kin_MMpi_vs_P_RFTime_pions_uncut", "Missing Mass vs SHMS RFTime (no cuts); MM_{#pi}; SHMS_RFTime_Dist", 100, 0, 2, 100, 0, 4)
...
P_kin_MMpi_vs_P_RFTime_pions_cut_all = ROOT.TH2D("P_kin_MMpi_vs_P_RFTime_pions_cut_all", "Missing Mass vs SHMS RFTime (with cuts); MM_{#pi}; SHMS_RFTime_Dist", 100, 0, 2, 100, 0, 4)
...
Q2vsW_pions = ROOT.TH2D("Q2vsW_pions", "Q2 vs W; Q2; W", 200, 1, 5, 200, 2.4, 4)
...
P_kin_MMK_vs_P_RFTime_kaons_uncut = ROOT.TH2D("P_kin_MMK_vs_P_RFTime_kaons_uncut", "Missing Mass vs SHMS RFTime (no cuts); MM_{K}; SHMS_RFTime_Dist", 100, 0, 2, 100, 0, 4)
...
P_kin_MMK_vs_P_RFTime_kaons_cut_all = ROOT.TH2D("P_kin_MMK_vs_P_RFTime_kaons_cut_all", "Missing Mass vs SHMS RFTime (with cuts); MM_{K}; SHMS_RFTime_Dist", 100, 0, 2, 100, 0, 4)
...
P_kin_MMK_vs_CTime_eKCoinTime_ROC1_kaons_cut_prompt = ROOT.TH2D("P_kin_MMK_vs_CTime_eKCoinTime_ROC1_kaons_cut_prompt","Missing Mass vs Electron-Kaon CTime; MM_{K}; e K Coin_Time",100, 0, 2, 100, -2, 2)
Q2vsW_kaons = ROOT.TH2D("Q2vsW_kaons", "Q2 vs W; Q2; W", 200, 1, 5, 200, 2.4, 4)
...
#    P_ngcer_yAtCer_pions_uncut.Fill(event.P_ngcer_yAtCer)
    ...
    P_kin_MMpi_vs_P_RFTime_pions_uncut.Fill(event.MMpi, event.P_RF_Dist)
...
#    P_ngcer_yAtCer_pions_cut_all.Fill(event.P_ngcer_yAtCer)   
    ...
    P_kin_MMpi_vs_P_RFTime_pions_cut_all.Fill(event.MMpi, event.P_RF_Dist)
...
#    P_ngcer_yAtCer_kaons_uncut.Fill(event.P_ngcer_yAtCer)
    ...
    P_kin_MMK_vs_P_RFTime_kaons_uncut.Fill(event.MMK, event.P_RF_Dist)
...
#    P_ngcer_yAtCer_kaons_cut_all.Fill(event.P_ngcer_yAtCer)   
    ...
    P_kin_MMK_vs_P_RFTime_kaons_cut_all.Fill(event.MMK, event.P_RF_Dist)
...
for event in Cut_Kaon_Events_Prompt_tree:
    ...
    P_kin_MMK_vs_CTime_eKCoinTime_ROC1_kaons_cut_prompt.Fill(event.MMK, event.CTime_eKCoinTime_ROC1)
...
P_kin_MMpi_vs_P_RFTime_pions_uncut.Write()
...
P_kin_MMpi_vs_P_RFTime_pions_cut_all.Write()
...
P_kin_MMK_vs_P_RFTime_kaons_uncut.Write()
...
P_kin_MMK_vs_P_RFTime_kaons_cut_all.Write()
...
P_kin_MMK_vs_CTime_eKCoinTime_ROC1_kaons_cut_prompt.Write()
