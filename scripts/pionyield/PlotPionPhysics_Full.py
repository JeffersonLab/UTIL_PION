...
c1_kin.cd(3)
phiqvst_pions_cut_all.GetYaxis().SetRangeUser(minrangeuser,maxrangeuser)
phiqvst_pions_cut_all.Draw("SURF2 POL")
...
BinIntegral_pions = int(P_kin_MMpi_pions_cut_random_sub.Integral(BinLow, BinHigh))
