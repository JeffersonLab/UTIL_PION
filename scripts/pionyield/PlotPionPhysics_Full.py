...
P_hgcer_vs_aero_npe_kaons_cut = ROOT.TH2D("P_hgcer_vs_aero_npe_kaons_cut", "SHMS HGC npeSum vs SHMS aero npeSum (with cuts); SHMS_hgcer_npeSum; SHMS_aero_npeSum", 100, 0, 5, 100, 0, 50)
...
P_ngcer_vs_hgcer_npe_kaons_cut = ROOT.TH2D("P_ngcer_vs_hgcer_npe_kaons_cut", "SHMS NGC npeSum vs SHMS HGC npeSum (with cuts); SHMS_ngcer_npeSum; SHMS_hgcer_npeSum", 100, 0, 50, 100, 0, 5)
...
P_hgcer_vs_aero_npe_protons_cut = ROOT.TH2D("P_hgcer_vs_aero_npe_protons_cut", "SHMS HGC npeSum vs SHMS aero npeSum (with cuts); SHMS_hgcer_npeSum; SHMS_aero_npeSum", 100, 0, 5, 100, 0, 5)
...
P_ngcer_vs_hgcer_npe_protons_cut = ROOT.TH2D("P_ngcer_vs_hgcer_npe_protons_cut", "SHMS NGC npeSum vs SHMS HGC npeSum (with cuts); SHMS_ngcer_npeSum; SHMS_hgcer_npeSum", 100, 0, 50, 100, 0, 5)
