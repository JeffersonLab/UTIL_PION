...
MMpi_hcana = e_tree.array("P.kin.secondary.MMpi")
MMK_hcana = e_tree.array("P.kin.secondary.MMK")
MMp_hcana = e_tree.array("P.kin.secondary.MMp")
...
# Should probably re-write this to get it to figure out which version to use on its own
# NOTE, this should be modified for NON different particle assumptions in hcana, this assumes a "pion" is specified in the kinematics file
...
# NOTE, this should be modified for NON different particle assumptions in hcana, this assumes a "proton" is specified in the kinematics file
#MMpi = np.array([math.sqrt(abs(((em+(math.sqrt((Mp*Mp)+(gtrp*gtrp)))-(math.sqrt((MPi*MPi)+(gtrp*gtrp))))**2)-(pm*pm))) for (em, pm, gtrp) in zip(emiss, pmiss, P_gtr_p)])
#MMK = np.array([math.sqrt(abs(((em+(math.sqrt((Mp*Mp)+(gtrp*gtrp)))-(math.sqrt((MK*MK)+(gtrp*gtrp))))**2)-(pm*pm))) for (em, pm, gtrp) in zip(emiss, pmiss, P_gtr_p)])
#MMp = np.array([math.sqrt(abs((em*em)-(pm*pm))) for (em, pm) in zip(emiss, pmiss)])
...
def coin_pions(): 
    ...
    NoCut_COIN_Pions = [H_gtr_beta, H_gtr_xp, H_gtr_yp, H_gtr_dp, H_cal_etotnorm, H_cal_etottracknorm, H_cer_npeSum, CTime_ePiCoinTime_ROC1, P_RF_tdcTime, P_hod_fpHitsTime, P_gtr_beta, P_gtr_xp, P_gtr_yp, P_gtr_p, P_gtr_dp, P_cal_etotnorm, P_cal_etottracknorm, P_aero_npeSum, P_aero_xAtAero, P_aero_yAtAero, P_hgcer_npeSum, P_hgcer_xAtCer, P_hgcer_yAtCer, MMpi, MMK, MMp, MMpi_hcana, MMK_hcana, MMp_hcana, RF_CutDist, H_RF_Dist, P_RF_Dist, Q2, W, epsilon, MandelT, MandelU, ph_q]
    Uncut_COIN_Pions = [(HBeta, Hxp, Hyp, Hdel, HCal, HCalTrack, HCer, CTPi, RF, HodStart, PiBeta, Pixp, Piyp, PiP, PiDel, PiCal, PiCalTrack, PiAero, PiAeroX, PiAeroY, PiHGC, PiHGCX, PiHGCY, mm1, mm2, mm3, mm4, mm5, mm6, RFCutDist, HRFDist, PRFDist, Kin_Q2, Kin_W, Kin_eps, Kin_t, Kin_u, phq) for (HBeta, Hxp, Hyp, Hdel, HCal, HCalTrack, HCer, CTPi, RF, HodStart, PiBeta, Pixp, Piyp, PiP, PiDel, PiCal, PiCalTrack, PiAero, PiAeroX, PiAeroY, PiHGC, PiHGCX, PiHGCY, mm1, mm2, mm3, mm4, mm5, mm6, RFCutDist, HRFDist, PRFDist, Kin_Q2, Kin_W, Kin_eps, Kin_t, Kin_u, phq) in zip(*NoCut_COIN_Pions)] 
    ...
    Cut_COIN_Pions_all = [(HBeta, Hxp, Hyp, Hdel, HCal, HCalTrack, HCer, CTPi, RF, HodStart, PiBeta, Pixp, Piyp, PiP, PiDel, PiCal, PiCalTrack, PiAero, PiAeroX, PiAeroY, PiHGC, PiHGCX, PiHGCY, mm1, mm2, mm3, mm4, mm5, mm6, RFCutDist, HRFDist, PRFDist, Kin_Q2, Kin_W, Kin_eps, Kin_t, Kin_u, phq) for (HBeta, Hxp, Hyp, Hdel, HCal, HCalTrack, HCer, CTPi, RF, HodStart, PiBeta, Pixp, Piyp, PiP, PiDel, PiCal, PiCalTrack, PiAero, PiAeroX, PiAeroY, PiHGC, PiHGCX, PiHGCY, mm1, mm2, mm3, mm4, mm5, mm6, RFCutDist, HRFDist, PRFDist, Kin_Q2, Kin_W, Kin_eps, Kin_t, Kin_u, phq) in zip(*Cut_COIN_Pions_all_tmp)
                          if RFCutDist > 2 and RFCutDist < 4]

    Cut_COIN_Pions_all_noRF = [(HBeta, Hxp, Hyp, Hdel, HCal, HCalTrack, HCer, CTPi, RF, HodStart, PiBeta, Pixp, Piyp, PiP, PiDel, PiCal, PiCalTrack, PiAero, PiAeroX, PiAeroY, PiHGC, PiHGCX, PiHGCY, mm1, mm2, mm3, mm4, mm5, mm6, RFCutDist, HRFDist, PRFDist, Kin_Q2, Kin_W, Kin_eps, Kin_t, Kin_u, phq) for (HBeta, Hxp, Hyp, Hdel, HCal, HCalTrack, HCer, CTPi, RF, HodStart, PiBeta, Pixp, Piyp, PiP, PiDel, PiCal, PiCalTrack, PiAero, PiAeroX, PiAeroY, PiHGC, PiHGCX, PiHGCY, mm1, mm2, mm3, mm4, mm5, mm6, RFCutDist, HRFDist, PRFDist, Kin_Q2, Kin_W, Kin_eps, Kin_t, Kin_u, phq) in zip(*Cut_COIN_Pions_all_noRF_tmp)]

    Cut_COIN_Pions_prompt = [(HBeta, Hxp, Hyp, Hdel, HCal, HCalTrack, HCer, CTPi, RF, HodStart, PiBeta, Pixp, Piyp, PiP, PiDel, PiCal, PiCalTrack, PiAero, PiAeroX, PiAeroY, PiHGC, PiHGCX, PiHGCY, mm1, mm2, mm3, mm4, mm5, mm6, RFCutDist, HRFDist, PRFDist, Kin_Q2, Kin_W, Kin_eps, Kin_t, Kin_u, phq) for (HBeta, Hxp, Hyp, Hdel, HCal, HCalTrack, HCer, CTPi, RF, HodStart, PiBeta, Pixp, Piyp, PiP, PiDel, PiCal, PiCalTrack, PiAero, PiAeroX, PiAeroY, PiHGC, PiHGCX, PiHGCY, mm1, mm2, mm3, mm4, mm5, mm6, RFCutDist, HRFDist, PRFDist, Kin_Q2, Kin_W, Kin_eps, Kin_t, Kin_u, phq) in zip(*Cut_COIN_Pions_prompt_tmp)
                             if RFCutDist > 2 and RFCutDist < 4]

    Cut_COIN_Pions_prompt_noRF = [(HBeta, Hxp, Hyp, Hdel, HCal, HCalTrack, HCer, CTPi, RF, HodStart, PiBeta, Pixp, Piyp, PiP, PiDel, PiCal, PiCalTrack, PiAero, PiAeroX, PiAeroY, PiHGC, PiHGCX, PiHGCY, mm1, mm2, mm3, mm4, mm5, mm6, RFCutDist, HRFDist, PRFDist, Kin_Q2, Kin_W, Kin_eps, Kin_t, Kin_u, phq) for (HBeta, Hxp, Hyp, Hdel, HCal, HCalTrack, HCer, CTPi, RF, HodStart, PiBeta, Pixp, Piyp, PiP, PiDel, PiCal, PiCalTrack, PiAero, PiAeroX, PiAeroY, PiHGC, PiHGCX, PiHGCY, mm1, mm2, mm3, mm4, mm5, mm6, RFCutDist, HRFDist, PRFDist, Kin_Q2, Kin_W, Kin_eps, Kin_t, Kin_u, phq) in zip(*Cut_COIN_Pions_prompt_noRF_tmp)]

    Cut_COIN_Pions_random = [(HBeta, Hxp, Hyp, Hdel, HCal, HCalTrack, HCer, CTPi, RF, HodStart, PiBeta, Pixp, Piyp, PiP, PiDel, PiCal, PiCalTrack, PiAero, PiAeroX, PiAeroY, PiHGC, PiHGCX, PiHGCY, mm1, mm2, mm3, mm4, mm5, mm6, RFCutDist, HRFDist, PRFDist, Kin_Q2, Kin_W, Kin_eps, Kin_t, Kin_u, phq) for (HBeta, Hxp, Hyp, Hdel, HCal, HCalTrack, HCer, CTPi, RF, HodStart, PiBeta, Pixp, Piyp, PiP, PiDel, PiCal, PiCalTrack, PiAero, PiAeroX, PiAeroY, PiHGC, PiHGCX, PiHGCY, mm1, mm2, mm3, mm4, mm5, mm6, RFCutDist, HRFDist, PRFDist, Kin_Q2, Kin_W, Kin_eps, Kin_t, Kin_u, phq) in zip(*Cut_COIN_Pions_rand_tmp)
                             if RFCutDist > 2 and RFCutDist < 4]

    Cut_COIN_Pions_random_noRF = [(HBeta, Hxp, Hyp, Hdel, HCal, HCalTrack, HCer, CTPi, RF, HodStart, PiBeta, Pixp, Piyp, PiP, PiDel, PiCal, PiCalTrack, PiAero, PiAeroX, PiAeroY, PiHGC, PiHGCX, PiHGCY, mm1, mm2, mm3, mm4, mm5, mm6, RFCutDist, HRFDist, PRFDist, Kin_Q2, Kin_W, Kin_eps, Kin_t, Kin_u, phq) for (HBeta, Hxp, Hyp, Hdel, HCal, HCalTrack, HCer, CTPi, RF, HodStart, PiBeta, Pixp, Piyp, PiP, PiDel, PiCal, PiCalTrack, PiAero, PiAeroX, PiAeroY, PiHGC, PiHGCX, PiHGCY, mm1, mm2, mm3, mm4, mm5, mm6, RFCutDist, HRFDist, PRFDist, Kin_Q2, Kin_W, Kin_eps, Kin_t, Kin_u, phq) in zip(*Cut_COIN_Pions_rand_noRF_tmp)]
...
def coin_kaons(): 
    # Define the array of arrays containing the relevant HMS and SHMS info
    NoCut_COIN_Kaons = [H_gtr_beta, H_gtr_xp, H_gtr_yp, H_gtr_dp, H_cal_etotnorm, H_cal_etottracknorm, H_cer_npeSum, CTime_eKCoinTime_ROC1, P_RF_tdcTime, P_hod_fpHitsTime, P_gtr_beta, P_gtr_xp, P_gtr_yp, P_gtr_p, P_gtr_dp, P_cal_etotnorm, P_cal_etottracknorm, P_aero_npeSum, P_aero_xAtAero, P_aero_yAtAero, P_hgcer_npeSum, P_hgcer_xAtCer, P_hgcer_yAtCer, MMpi, MMK, MMp, MMpi_hcana, MMK_hcana, MMp_hcana, RF_CutDist, H_RF_Dist, P_RF_Dist, Q2, W, epsilon, MandelT, MandelU, ph_q]
    Uncut_COIN_Kaons = [(HBeta, Hxp, Hyp, Hdel, HCal, HCalTrack, HCer, CTK, RF, HodStart, KBeta, Kxp, Kyp, KP, KDel, KCal, KCalTrack, KAero, KAeroX, KAeroY, KHGC, KHGCX, KHGCY, mm1, mm2, mm3, mm4, mm5, mm6, RFCutDist, HRFDist, PRFDist, Kin_Q2, Kin_W, Kin_eps, Kin_t, Kin_u, phq) for (HBeta, Hxp, Hyp, Hdel, HCal, HCalTrack, HCer, CTK, RF, HodStart, KBeta, Kxp, Kyp, KP, KDel, KCal, KCalTrack, KAero, KAeroX, KAeroY, KHGC, KHGCX, KHGCY, mm1, mm2, mm3, mm4, mm5, mm6, RFCutDist, HRFDist, PRFDist, Kin_Q2, Kin_W, Kin_eps, Kin_t, Kin_u, phq) in zip(*NoCut_COIN_Kaons)] 
    ...
    Cut_COIN_Kaons_all = [(HBeta, Hxp, Hyp, Hdel, HCal, HCalTrack, HCer, CTK, RF, HodStart, KBeta, Kxp, Kyp, KP, KDel, KCal, KCalTrack, KAero, KAeroX, KAeroY, KHGC, KHGCX, KHGCY, mm1, mm2, mm3, mm4, mm5, mm6, RFCutDist, HRFDist, PRFDist, Kin_Q2, Kin_W, Kin_eps, Kin_t, Kin_u, phq) for (HBeta, Hxp, Hyp, Hdel, HCal, HCalTrack, HCer, CTK, RF, HodStart, KBeta, Kxp, Kyp, KP, KDel, KCal, KCalTrack, KAero, KAeroX, KAeroY, KHGC, KHGCX, KHGCY, mm1, mm2, mm3, mm4, mm5, mm6, RFCutDist, HRFDist, PRFDist, Kin_Q2, Kin_W, Kin_eps, Kin_t, Kin_u, phq) in zip(*Cut_COIN_Kaons_all_tmp)
                    if RFCutDist > 1.3 and RFCutDist < 3]

    Cut_COIN_Kaons_prompt = [(HBeta, Hxp, Hyp, Hdel, HCal, HCalTrack, HCer, CTK, RF, HodStart, KBeta, Kxp, Kyp, KP, KDel, KCal, KCalTrack, KAero, KAeroX, KAeroY, KHGC, KHGCX, KHGCY, mm1, mm2, mm3, mm4, mm5, mm6, RFCutDist, HRFDist, PRFDist, Kin_Q2, Kin_W, Kin_eps, Kin_t, Kin_u, phq) for (HBeta, Hxp, Hyp, Hdel, HCal, HCalTrack, HCer, CTK, RF, HodStart, KBeta, Kxp, Kyp, KP, KDel, KCal, KCalTrack, KAero, KAeroX, KAeroY, KHGC, KHGCX, KHGCY, mm1, mm2, mm3, mm4, mm5, mm6, RFCutDist, HRFDist, PRFDist, Kin_Q2, Kin_W, Kin_eps, Kin_t, Kin_u, phq) in zip(*Cut_COIN_Kaons_prompt_tmp)
                    if RFCutDist > 1.3 and RFCutDist < 3]

    Cut_COIN_Kaons_random = [(HBeta, Hxp, Hyp, Hdel, HCal, HCalTrack, HCer, CTK, RF, HodStart, KBeta, Kxp, Kyp, KP, KDel, KCal, KCalTrack, KAero, KAeroX, KAeroY, KHGC, KHGCX, KHGCY, mm1, mm2, mm3, mm4, mm5, mm6, RFCutDist, HRFDist, PRFDist, Kin_Q2, Kin_W, Kin_eps, Kin_t, Kin_u, phq) for (HBeta, Hxp, Hyp, Hdel, HCal, HCalTrack, HCer, CTK, RF, HodStart, KBeta, Kxp, Kyp, KP, KDel, KCal, KCalTrack, KAero, KAeroX, KAeroY, KHGC, KHGCX, KHGCY, mm1, mm2, mm3, mm4, mm5, mm6, RFCutDist, HRFDist, PRFDist, Kin_Q2, Kin_W, Kin_eps, Kin_t, Kin_u, phq) in zip(*Cut_COIN_Kaons_rand_tmp)
                    if RFCutDist > 1.3 and RFCutDist < 3]
...
def coin_protons(): 
    # Define the array of arrays containing the relevant HMS and SHMS info
    NoCut_COIN_Protons = [H_gtr_beta, H_gtr_xp, H_gtr_yp, H_gtr_dp, H_cal_etotnorm, H_cal_etottracknorm, H_cer_npeSum, CTime_epCoinTime_ROC1, P_RF_tdcTime, P_hod_fpHitsTime, P_gtr_beta, P_gtr_xp, P_gtr_yp, P_gtr_p, P_gtr_dp, P_cal_etotnorm, P_cal_etottracknorm, P_aero_npeSum, P_aero_xAtAero, P_aero_yAtAero, P_hgcer_npeSum, P_hgcer_xAtCer, P_hgcer_yAtCer, MMpi, MMK, MMp, MMpi_hcana, MMK_hcana, MMp_hcana, RF_CutDist, H_RF_Dist, P_RF_Dist, Q2, W, epsilon, MandelT, MandelU, ph_q]
    Uncut_COIN_Protons = [(HBeta, Hxp, Hyp, Hdel, HCal, HCalTrack, HCer, CTp, RF, HodStart, pBeta, pxp, pyp, pP, pDel, pCal, pCalTrack, pAero, pAeroX, pAeroY, pHGC, pHGCX, pHGCY, mm1, mm2, mm3, mm4, mm5, mm6, RFCutDist, HRFDist, PRFDist, Kin_Q2, Kin_W, Kin_eps, Kin_t, Kin_u, phq) for (HBeta, Hxp, Hyp, Hdel, HCal, HCalTrack, HCer, CTp, RF, HodStart, pBeta, pxp, pyp, pP, pDel, pCal, pCalTrack, pAero, pAeroX, pAeroY, pHGC, pHGCX, pHGCY, mm1, mm2, mm3, mm4, mm5, mm6, RFCutDist, HRFDist, PRFDist, Kin_Q2, Kin_W, Kin_eps, Kin_t, Kin_u, phq) in zip(*NoCut_COIN_Protons)] 
