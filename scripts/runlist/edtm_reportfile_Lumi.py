...
if TestVar != 15 and TestVar > 15 :
    ...
    RunListEntry=("%.3f,%i,%i,%i,%.3f,%.3f,%.3f,%.3f,%ik,%ik,%ik,%i,%.3f,%.3f,%.3f" % (Current, PS2, PS4, PS5, HMS_Rate, SHMS_Rate, COIN_Rate, Charge, Raw_HMS, Raw_SHMS, Raw_COIN, EDTM, Elec_Track, HMStime, SHMStime) )
